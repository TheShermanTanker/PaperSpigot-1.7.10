...
/* 102 */     DefaultPermissions.registerPermission("bukkit.command.help", "Allows the user to view the vanilla help menu", PermissionDefault.TRUE, commands);
...
/* 106 */     DefaultPermissions.registerPermission("bukkit.command.gamemode", "Allows the user to change the gamemode of another player", PermissionDefault.OP, commands);
/* 107 */     DefaultPermissions.registerPermission("bukkit.command.xp", "Allows the user to give themselves or others arbitrary values of experience", PermissionDefault.OP, commands);
/* 108 */     DefaultPermissions.registerPermission("bukkit.command.toggledownfall", "Allows the user to toggle rain on/off for a given world", PermissionDefault.OP, commands);
/* 109 */     DefaultPermissions.registerPermission("bukkit.command.defaultgamemode", "Allows the user to change the default gamemode of the server", PermissionDefault.OP, commands);
/* 110 */     DefaultPermissions.registerPermission("bukkit.command.seed", "Allows the user to view the seed of the world", PermissionDefault.OP, commands);
/* 111 */     DefaultPermissions.registerPermission("bukkit.command.effect", "Allows the user to add/remove effects on players", PermissionDefault.OP, commands);
/*     */     
...
/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\org\bukki\\util\permissions\CommandPermissions.class
