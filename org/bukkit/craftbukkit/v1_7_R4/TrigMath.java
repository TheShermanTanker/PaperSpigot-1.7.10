...
/* 32 */     return (arg < 0.41421356237309503D) ? mxatan(arg) : ((arg > 2.414213562373095D) ? (1.5707963267948966D - mxatan(1.0D / arg)) : (0.7853981633974483D + mxatan((arg - 1.0D) / (arg + 1.0D))));
/*    */   }
/*    */ 
/*    */ 
/*    */   
...
/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\org\bukkit\craftbukkit\v1_7_R4\TrigMath.class
