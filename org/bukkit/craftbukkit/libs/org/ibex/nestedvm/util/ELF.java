...
/* 101 */       if (this.klass != 1) throw new ELF.ELFException(this$0, "org.bukkit.craftbukkit.libs.org.ibex.nestedvm.util.ELF does not suport 64-bit binaries");
/*     */       
...
/* 168 */       return ((this.flags & 0x2) != 0);
/*     */     }
/*     */     public InputStream getInputStream() throws IOException {
/* 171 */       return new BufferedInputStream(new ELF.SectionInputStream(this.this$0, this.offset, this.offset + this.filesz));
/*     */     } }
/*     */ 
/*     */   
/*     */   public class SHeader { int nameidx;
/*     */     public String name;
/*     */     public int type;
/*     */     public int flags;
/*     */     public int addr;
...
/*     */     
/*     */     public InputStream getInputStream() throws IOException {
/* 203 */       return new BufferedInputStream(new ELF.SectionInputStream(this.this$0, this.offset, (this.type == 8) ? 0 : (this.offset + this.size)));
/*     */     }
/*     */     
/*     */     public boolean isText() {
/* 207 */       return this.name.equals(".text");
/* 208 */     } public boolean isData() { return (this.name.equals(".data") || this.name.equals(".sdata") || this.name.equals(".rodata") || this.name.equals(".ctors") || this.name.equals(".dtors")); } public boolean isBSS() {
/* 209 */       return (this.name.equals(".bss") || this.name.equals(".sbss"));
/*     */     } }
/*     */   public ELF(String paramString) throws IOException, ELFException {
/* 212 */     this(new Seekable.File(paramString, false));
...
/* 217 */     this.pheaders = new PHeader[this.header.phnum]; byte b;
/* 218 */     for (b = 0; b < this.header.phnum; b++) {
/* 219 */       paramSeekable.seek(this.header.phoff + b * this.header.phentsize);
/* 220 */       this.pheaders[b] = new PHeader(this);
/*     */     } 
/* 222 */     this.sheaders = new SHeader[this.header.shnum];
/* 223 */     for (b = 0; b < this.header.shnum; b++) {
/* 224 */       paramSeekable.seek(this.header.shoff + b * this.header.shentsize);
/* 225 */       this.sheaders[b] = new SHeader(this);
/*     */     } 
...
/*     */     
/* 232 */     for (b = 0; b < this.header.shnum; b++) {
/* 233 */       SHeader sHeader = this.sheaders[b];
/* 234 */       sHeader.name = getString(sHeader.nameidx);
/*     */     } 
/*     */   }
/*     */   private String getString(int paramInt) {
/* 238 */     return getString(paramInt, this.stringTable);
...
/*     */     ELFException(ELF this$0, String param1String) {
/* 253 */       super(param1String); this.this$0 = this$0;
/*     */     } }
...
/* 267 */       return this.maxpos - this.pos;
...
/*     */     } public void close() {
/* 275 */       this.this$0.sectionReaderActive = false;
/*     */     } }
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/*     */   public class Symbol { public String name;
/*     */     public int addr;
/*     */     public int size;
/*     */     public byte info;
/*     */     public byte type;
...
/* 355 */     return "0x" + Long.toString(paramInt & 0xFFFFFFFFL, 16);
/*     */   }
/*     */ }
