...
/*  37 */     this.fcsr = this.fcsr & 0xFF7FFFFF | (paramBoolean ? 8388608 : 0); } private final int roundingMode() {
/*  38 */     return this.fcsr & 0x3;
/*     */   } private final double getDouble(int paramInt) {
/*  40 */     return Double.longBitsToDouble((this.fpregs[paramInt + 1] & 0xFFFFFFFFL) << 32L | this.fpregs[paramInt] & 0xFFFFFFFFL);
/*     */   }
/*     */   private final void setDouble(int paramInt, double paramDouble) {
/*  43 */     long l = Double.doubleToLongBits(paramDouble);
/*  44 */     this.fpregs[paramInt + 1] = (int)(l >>> 32L); this.fpregs[paramInt] = (int)l;
/*     */   }
/*  46 */   private final float getFloat(int paramInt) { return Float.intBitsToFloat(this.fpregs[paramInt]); } private final void setFloat(int paramInt, float paramFloat) {
/*  47 */     this.fpregs[paramInt] = Float.floatToRawIntBits(paramFloat);
/*     */   }
...
/*  72 */     int k = j + 4; try {
/*     */       while (true) {
/*     */         int m, i13; long l; boolean bool1; String str; boolean bool2;
/*     */         int i14;
/*     */         try {
...
/* 304 */             bool2 = (bool1 && (str.indexOf("dtoa.c:51") >= 0 || str.indexOf("dtoa.c:52") >= 0 || str.indexOf("test.c") >= 0)) ? true : false;
/* 305 */             if (i1 > 8 && bool2)
...
/*     */                 break;
/*     */               case 8:
/* 325 */                 if ((((this.fcsr & 0x800000) != 0) ? true : false) == (((m >>> 16 & 0x1) != 0) ? true : false)) {
...
/* 361 */                       case 3: arrayOfInt2[i7] = (int)Math.floor(getFloat(i5)); break; }
/*     */                     
/*     */                     break;
/*     */                   case 50:
...
/* 453 */             } catch (RuntimeException runtimeException) {
/* 454 */               i13 = memRead(i14 & 0xFFFFFFFC);
/*     */             } 
...
/* 470 */             } catch (RuntimeException runtimeException) {
/* 471 */               i13 = memRead(i14 & 0xFFFFFFFC);
/*     */             } 
...
/* 487 */               i13 = memRead(i14 & 0xFFFFFFFC);
/*     */             } 
/* 489 */             switch (i14 & 0x3) { case 0:
/* 490 */                 arrayOfInt1[i2] = arrayOfInt1[i2] & 0x0 | i13 << 0; break;
...
/* 501 */             } catch (RuntimeException runtimeException) {
/* 502 */               arrayOfInt1[i2] = memRead(i14);
/*     */             } 
/*     */             break;
/*     */           case 36:
...
/* 509 */             } catch (RuntimeException runtimeException) {
/* 510 */               i13 = memRead(i14);
/*     */             } 
...
/* 524 */             } catch (RuntimeException runtimeException) {
/* 525 */               i13 = memRead(i14 & 0xFFFFFFFC);
/*     */             } 
...
/* 538 */             } catch (RuntimeException runtimeException) {
/* 539 */               i13 = memRead(i14 & 0xFFFFFFFC);
/*     */             } 
...
/* 553 */             } catch (RuntimeException runtimeException) {
/* 554 */               i13 = memRead(i14 & 0xFFFFFFFC);
/*     */             } 
...
/* 564 */             } catch (RuntimeException runtimeException) {
/* 565 */               memWrite(i14 & 0xFFFFFFFC, i13);
/*     */             } 
/*     */             break;
/*     */           
/*     */           case 41:
...
/* 574 */               i13 = memRead(i14 & 0xFFFFFFFC);
/*     */             } 
...
/* 584 */               memWrite(i14 & 0xFFFFFFFC, i13);
/*     */             } 
/*     */             break;
/*     */           
/*     */           case 42:
...
/* 592 */                 i13 = i13 & 0x0 | arrayOfInt1[i2] >>> 0; break;
...
/* 599 */             } catch (RuntimeException runtimeException) {
/* 600 */               memWrite(i14 & 0xFFFFFFFC, i13);
/*     */             } 
/*     */             break;
/*     */           
/*     */           case 43:
...
/* 609 */               memWrite(i14 & 0xFFFFFFFC, arrayOfInt1[i2]);
/*     */             } 
/*     */             break;
/*     */           case 46:
...
/* 619 */               case 3: i13 = i13 & 0x0 | arrayOfInt1[i2] << 0; break; }
/*     */             
...
/*     */   }
/*     */   
/* 661 */   protected int userInfoBae() { return (this.userInfo == null) ? 0 : this.userInfo.addr; } protected int userInfoSize() {
/* 662 */     return (this.userInfo == null) ? 0 : this.userInfo.size;
/*     */   }
/*     */   protected int entryPoint() {
/* 665 */     return this.entryPoint;
/*     */   }
/*     */   protected int heapStart() {
/* 668 */     return this.heapStart;
/*     */   }
/*     */   
...
/* 683 */     this.userInfo = symtab.getGlobalSymbol("user_info");
/* 684 */     ELF.Symbol symbol = symtab.getGlobalSymbol("_gp");
/*     */     
...
/* 718 */               n -= 4;
/* 719 */               if (n <= 0)
/* 720 */               { dataInputStream.close(); break; }  }  } 
/*     */         } 
/*     */       } 
...
/* 745 */     this((Seekable)new Seekable.File(paramString, false));
/* 746 */     this.image = paramString;
/*     */   } public Interpreter(InputStream paramInputStream) throws IOException {
/* 748 */     this((Seekable)new Seekable.InputStream(paramInputStream));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 755 */     String str = (this.sourceLineCache == null) ? null : (String)this.sourceLineCache.get(new Integer(paramInt));
...
/*     */     public DebugShutdownHook(Interpreter this$0) {
/* 771 */       this.this$0 = this$0;
/*     */     } public void run() {
