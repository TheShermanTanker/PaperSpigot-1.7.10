...
/*  20 */   String source = "unknown.mips.binary"; public void setSource(String paramString) {
/*  21 */     this.source = paramString;
/*     */   }
/*     */   static class Exn extends Exception { public Exn(String param1String) {
/*  24 */       super(param1String);
/*     */     } }
/*     */ 
/*     */ 
/*     */ 
...
/*  77 */   int totalPages = 65536; int pageShift;
/*     */   boolean onePage;
...
/*  97 */     for (byte b = 0; b < options.length; b += 2)
/*  98 */       System.err.print(options[b] + ": " + wrapAndIndent(options[b + 1], 16 - options[b].length(), 18, 62)); 
/*  99 */     System.exit(1);
/*     */   }
...
/* 110 */     byte b = 0;
/* 111 */     while (paramArrayOfString.length - b > 0) {
/* 112 */       if (paramArrayOfString[b].equals("-outfile")) {
/* 113 */         b++;
/* 114 */         if (b == paramArrayOfString.length) usage(); 
/* 115 */         str1 = paramArrayOfString[b];
/* 116 */       } else if (paramArrayOfString[b].equals("-d")) {
/* 117 */         b++;
/* 118 */         if (b == paramArrayOfString.length) usage(); 
/* 119 */         str2 = paramArrayOfString[b];
/* 120 */       } else if (paramArrayOfString[b].equals("-outformat")) {
/* 121 */         b++;
/* 122 */         if (b == paramArrayOfString.length) usage(); 
/* 123 */         str6 = paramArrayOfString[b];
/* 124 */       } else if (paramArrayOfString[b].equals("-o")) {
/* 125 */         b++;
/* 126 */         if (b == paramArrayOfString.length) usage(); 
/* 127 */         if (str3 == null || str3.length() == 0)
/* 128 */         { str3 = paramArrayOfString[b]; }
/* 129 */         else if (paramArrayOfString[b].length() != 0)
/* 130 */         { str3 = str3 + "," + paramArrayOfString[b]; } 
/* 131 */       } else if (paramArrayOfString[b].equals("-dumpoptions")) {
/* 132 */         bool = true;
/* 133 */       } else if (str4 == null) {
/* 134 */         str4 = paramArrayOfString[b];
/* 135 */       } else if (str5 == null) {
/* 136 */         str5 = paramArrayOfString[b];
/*     */       } else {
/* 138 */         usage();
/*     */       } 
/* 140 */       b++;
...
/*     */     
/* 146 */     OutputStreamWriter outputStreamWriter = null;
/* 147 */     FileOutputStream fileOutputStream = null;
/* 148 */     ClassFileCompiler classFileCompiler = null;
/* 149 */     if (str6 == null || str6.equals("class")) {
/* 150 */       if (str1 != null) {
/* 151 */         fileOutputStream = new FileOutputStream(str1);
/* 152 */         classFileCompiler = new ClassFileCompiler((Seekable)file, str4, fileOutputStream);
...
/* 157 */           System.exit(1);
/*     */         } 
/* 159 */         classFileCompiler = new ClassFileCompiler((Seekable)file, str4, file1);
/*     */       } else {
...
/* 166 */       javaSourceCompiler = new JavaSourceCompiler((Seekable)file, str4, outputStreamWriter);
/*     */     } else {
...
/* 177 */       for (byte b1 = 0; b1 < options.length; b1 += 2)
/* 178 */         System.err.println(options[b1] + ": " + javaSourceCompiler.getOption(options[b1]).get()); 
...
/*     */   }
/*     */   
/*     */   public Compiler(Seekable paramSeekable, String paramString) throws IOException {
...
/* 298 */           switch (i6) {
/*     */             case 9:
/* 300 */               if (paramHashtable.put(new Integer(j + 8), Boolean.TRUE) == null) b1++; 
/*     */               break;
/*     */             case 12:
/* 303 */               if (paramHashtable.put(new Integer(j + 4), Boolean.TRUE) == null) b1++; 
/*     */               break;
/*     */           } 
/*     */           break;
/*     */         case 1:
...
/*     */             case 16:
/*     */             case 17:
/* 311 */               if (paramHashtable.put(new Integer(j + 8), Boolean.TRUE) == null) b1++;
/*     */             
/*     */             case 0:
/*     */             case 1:
/* 315 */               if (paramHashtable.put(new Integer(j + i4 * 4 + 4), Boolean.TRUE) == null) b1++; 
/*     */               break;
/*     */           } 
/*     */           break;
/*     */         case 3:
...
/* 352 */           switch (n) {
/*     */             case 8:
/* 354 */               if (paramHashtable.put(new Integer(j + i4 * 4 + 4), Boolean.TRUE) == null) b1++; 
/*     */               break;
/*     */           } 
/*     */           break;
/*     */       } 
...
/* 381 */     return "0x" + Long.toString(paramInt & 0xFFFFFFFFL, 16);
...
/*     */     
/*     */     public Option(Compiler this$0, String param1String) throws NoSuchFieldException {
/* 402 */       this.this$0 = this$0; this.field = (param1String == null) ? null : ((Compiler.class$org$ibex$nestedvm$Compiler == null) ? (Compiler.class$org$ibex$nestedvm$Compiler = Compiler.class$("org.bukkit.craftbukkit.libs.org.ibex.nestedvm.Compiler")) : Compiler.class$org$ibex$nestedvm$Compiler).getDeclaredField(param1String);
...
/*     */     try {
/* 448 */       for (byte b = 0; b < options.length; b += 2) {
/* 449 */         if (options[b].toLowerCase().equals(paramString))
/* 450 */           return new Option(this, options[b]); 
/* 451 */       }  return null;
...
/* 461 */       String str2, str3, str1 = stringTokenizer.nextToken();
/*     */ 
/*     */       
...
/* 489 */         option.set(new Boolean((str3.toLowerCase().equals("true") || str3.toLowerCase().equals("yes")))); continue;
/*     */       } 
