...
/*     */   
/* 111 */   private final ThreadLocal<Map<TypeToken<?>, FutureTypeAdapter<?>>> calls = new ThreadLocal<Map<TypeToken<?>, FutureTypeAdapter<?>>>()
/*     */     {
/*     */       protected Map<TypeToken<?>, Gson.FutureTypeAdapter<?>> initialValue() {
/* 114 */         return new HashMap<TypeToken<?>, Gson.FutureTypeAdapter<?>>();
/*     */       }
/*     */     };
/*     */   
/* 118 */   private final Map<TypeToken<?>, TypeAdapter<?>> typeTokenCache = Collections.synchronizedMap(new HashMap<TypeToken<?>, TypeAdapter<?>>());
/*     */   
...
/*     */     
/* 198 */     ReflectiveTypeAdapterFactory reflectiveTypeAdapterFactory = new ReflectiveTypeAdapterFactory(this.constructorConstructor, fieldNamingPolicy, excluder);
/*     */ 
/*     */     
/* 201 */     ConstructorConstructor constructorConstructor = new ConstructorConstructor();
/* 202 */     List<TypeAdapterFactory> factories = new ArrayList<TypeAdapterFactory>();
/*     */ 
/*     */     
...
/* 221 */     factories.add(TypeAdapters.newFactory(BigDecimal.class, (TypeAdapter)new BigDecimalTypeAdapter()));
/* 222 */     factories.add(TypeAdapters.newFactory(BigInteger.class, (TypeAdapter)new BigIntegerTypeAdapter()));
...
/*     */     }
/* 255 */     return new TypeAdapter<Number>() {
...
/*     */     }
/* 279 */     return new TypeAdapter<Number>() {
...
/*     */     }
/* 311 */     return new TypeAdapter<Number>() {
...
/* 337 */     TypeAdapter<?> cached = this.typeTokenCache.get(type);
/* 338 */     if (cached != null) {
/* 339 */       return (TypeAdapter)cached;
/*     */     }
/*     */     
/* 342 */     Map<TypeToken<?>, FutureTypeAdapter<?>> threadCalls = this.calls.get();
/*     */     
/* 344 */     FutureTypeAdapter<T> ongoingCall = (FutureTypeAdapter<T>)threadCalls.get(type);
/* 345 */     if (ongoingCall != null) {
/* 346 */       return ongoingCall;
/*     */     }
/*     */     
/* 349 */     FutureTypeAdapter<T> call = new FutureTypeAdapter<T>();
/* 350 */     threadCalls.put(type, call);
/*     */     try {
/* 352 */       for (TypeAdapterFactory factory : this.factories) {
/* 353 */         TypeAdapter<T> candidate = factory.create(this, type);
...
/*     */               continue;
/*     */             } 
/* 380 */             TypeAdapter<T> candidate = factory.create(gson, type);
...
/* 439 */     toJson(src, typeOfSrc, (JsonWriter)writer);
...
/* 670 */     T target = fromJson(reader, typeOfT);
/* 671 */     return target;
/*     */   }
/*     */ 
/*     */ 
...
/* 721 */     T object = fromJson(jsonReader, typeOfT);
...
/*     */       }
/* 731 */     } catch (MalformedJsonException e) {
...
/* 752 */       reader.peek();
/* 753 */       isEmpty = false;
/* 754 */       TypeAdapter<T> typeAdapter = getAdapter(TypeToken.get(typeOfT));
/* 755 */       return typeAdapter.read(reader);
/* 756 */     } catch (EOFException e) {
/*     */ 
/*     */ 
/*     */ 
/*     */       
...
/* 817 */       return null;
/*     */     }
/* 819 */     return fromJson((JsonReader)new JsonTreeReader(json), typeOfT);
/*     */   }
/*     */   
...
/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\org\bukkit\craftbukkit\libs\com\google\gson\Gson.class
