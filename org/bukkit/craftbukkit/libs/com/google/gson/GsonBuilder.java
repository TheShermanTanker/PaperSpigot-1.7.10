...
/*  73 */   private final Map<Type, InstanceCreator<?>> instanceCreators = new HashMap<Type, InstanceCreator<?>>();
/*     */   
/*  75 */   private final List<TypeAdapterFactory> factories = new ArrayList<TypeAdapterFactory>();
/*     */   
/*  77 */   private final List<TypeAdapterFactory> hierarchyFactories = new ArrayList<TypeAdapterFactory>();
...
/*     */   
/*     */   public Gson create() {
/* 540 */     List<TypeAdapterFactory> factories = new ArrayList<TypeAdapterFactory>();
...
/* 557 */     } else if (dateStyle != 2 && timeStyle != 2) {
/* 558 */       dateTypeAdapter = new DefaultDateTypeAdapter(dateStyle, timeStyle);
/*     */     } else {
/*     */       return;
/*     */     } 
/*     */     
/* 563 */     factories.add(TreeTypeAdapter.newFactory(TypeToken.get(Date.class), dateTypeAdapter));
/* 564 */     factories.add(TreeTypeAdapter.newFactory(TypeToken.get(Timestamp.class), dateTypeAdapter));
/* 565 */     factories.add(TreeTypeAdapter.newFactory(TypeToken.get(Date.class), dateTypeAdapter));
/*     */   }
/*     */ }


/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\org\bukkit\craftbukkit\libs\com\google\gson\GsonBuilder.class
