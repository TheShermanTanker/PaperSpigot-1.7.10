...
/*  60 */     this.columns = new LinkedList<Column>();
/*     */     
/*  62 */     clear();
/*     */   }
/*     */ 
...
/* 118 */     int maxHeight = ((Column)Collections.<Column>max(this.columns, Column.BY_HEIGHT)).height();
/*     */     
...
/* 155 */       addPaddingCellsForColumn(iter.next(), maxHeight, numberOfCellsAddedAt[i]); 
/*     */   }
/*     */   
...
/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\org\bukkit\craftbukkit\libs\joptsimple\internal\ColumnarData.class
