...
/*     */   private String key;
/*     */   private V value;
/*  67 */   private final Map<Character, AbbreviationMap<V>> children = new TreeMap<Character, AbbreviationMap<V>>();
/*     */ 
/*     */ 
/*     */ 
/*     */   
...
/*  96 */       child = child.children.get(Character.valueOf(each));
/*  97 */       if (child == null) {
/*  98 */         return null;
/*     */       }
/*     */     } 
/* 101 */     return child.value;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 146 */     AbbreviationMap<V> child = this.children.get(Character.valueOf(nextChar));
/* 147 */     if (child == null) {
/* 148 */       child = new AbbreviationMap();
...
/* 183 */     AbbreviationMap<V> child = this.children.get(Character.valueOf(nextChar));
...
/* 197 */     Map.Entry<Character, AbbreviationMap<V>> entry = this.children.entrySet().iterator().next();
/* 198 */     AbbreviationMap<V> onlyChild = entry.getValue();
...
/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\org\bukkit\craftbukkit\libs\joptsimple\internal\AbbreviationMap.class
