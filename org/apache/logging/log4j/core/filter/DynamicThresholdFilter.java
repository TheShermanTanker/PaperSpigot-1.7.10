...
/*     */       }
/*  88 */       return level.isAtLeastAsSpecificAs(ctxLevel) ? this.onMatch : this.onMismatch;
/*     */     } 
...
/* 134 */     Filter.Result onMatch = Filter.Result.toResult(match);
/* 135 */     Filter.Result onMismatch = Filter.Result.toResult(mismatch);
/* 136 */     Map<String, Level> map = new HashMap<String, Level>();
/* 137 */     for (KeyValuePair pair : pairs) {
/* 138 */       map.put(pair.getKey(), Level.toLevel(pair.getValue()));
/*     */     }
/* 140 */     Level level = Level.toLevel(levelName, Level.ERROR);
/* 141 */     return new DynamicThresholdFilter(key, map, level, onMatch, onMismatch);
/*     */   }
/*     */ }


/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\org\apache\logging\log4j\core\filter\DynamicThresholdFilter.class
