...
/* 139 */     Filter.Result onMatch = Filter.Result.toResult(match);
/* 140 */     Filter.Result onMismatch = Filter.Result.toResult(mismatch);
/* 141 */     return new StructuredDataFilter(map, isAnd, onMatch, onMismatch);
/*     */   }
/*     */ }


/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\org\apache\logging\log4j\core\filter\StructuredDataFilter.class
