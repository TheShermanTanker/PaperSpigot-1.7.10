...
/* 149 */     Filter.Result onMatch = Filter.Result.toResult(match);
/* 150 */     Filter.Result onMismatch = Filter.Result.toResult(mismatch);
/* 151 */     return new ThreadContextMapFilter(map, isAnd, onMatch, onMismatch);
/*     */   }
/*     */ }


/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\org\apache\logging\log4j\core\filter\ThreadContextMapFilter.class
