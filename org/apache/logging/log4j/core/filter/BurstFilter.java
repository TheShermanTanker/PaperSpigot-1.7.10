...
/* 233 */     Filter.Result onMatch = Filter.Result.toResult(match, Filter.Result.NEUTRAL);
/* 234 */     Filter.Result onMismatch = Filter.Result.toResult(mismatch, Filter.Result.DENY);
/* 235 */     Level level = Level.toLevel(levelName, Level.WARN);
/* 236 */     float eventRate = (rate == null) ? 10.0F : Float.parseFloat(rate);
/* 237 */     if (eventRate <= 0.0F) {
/* 238 */       eventRate = 10.0F;
/*     */     }
/* 240 */     long max = (maxBurst == null) ? (long)(eventRate * 100.0F) : Long.parseLong(maxBurst);
/* 241 */     return new BurstFilter(level, eventRate, max, onMatch, onMismatch);
/*     */   }
/*     */ }


/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\org\apache\logging\log4j\core\filter\BurstFilter.class
