...
/* 131 */     Filter.Result onMatch = Filter.Result.toResult(match, Filter.Result.NEUTRAL);
/* 132 */     Filter.Result onMismatch = Filter.Result.toResult(mismatch, Filter.Result.DENY);
/* 133 */     return new TimeFilter(s, e, timezone, onMatch, onMismatch);
/*     */   }
/*     */ }


/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\org\apache\logging\log4j\core\filter\TimeFilter.class
