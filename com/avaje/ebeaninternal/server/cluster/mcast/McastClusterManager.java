...
/*     */ 
/*     */   
/*  94 */   private final ArrayList<MessageResend> resendMessages = new ArrayList<MessageResend>();
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*  99 */   private final ArrayList<MessageControl> controlMessages = new ArrayList<MessageControl>();
/*     */ 
/*     */ 
/*     */ 
/*     */   
...
/* 195 */     this.managerSleepMillis = GlobalProperties.getInt("ebean.cluster.mcast.managerSleepMillis", 80);
/* 196 */     this.lastSendTimeFreqMillis = 1000 * GlobalProperties.getInt("ebean.cluster.mcast.pingFrequencySecs", 300);
/* 197 */     this.lastStatusTimeFreqMillis = 1000 * GlobalProperties.getInt("ebean.cluster.mcast.statusFrequencySecs", 600);
/*     */ 
/*     */     
/* 200 */     this.maxResendOutgoing = GlobalProperties.getInt("ebean.cluster.mcast.maxResendOutgoing", 200);
/*     */     
...
/* 393 */       for (int i = 0; i < this.resendMessages.size(); i++) {
/* 394 */         MessageResend resendMsg = this.resendMessages.get(i);
...
/* 402 */         Long resendPacketId = it.next();
/* 403 */         Packet packet = this.outgoingPacketsCache.getPacket(resendPacketId);
/* 404 */         if (packet == null) {
/* 405 */           String str = "Cluster unable to resend packet[" + resendPacketId + "] as it is no longer in the outgoingPacketsCache";
/* 406 */           logger.log(Level.SEVERE, str); continue;
/*     */         } 
...
/* 444 */       MessageControl message = this.controlMessages.get(i);
/*     */       
...
/* 509 */     return (SpiEbeanServer)this.clusterManager.getServer(serverName);
/*     */   }
/*     */   
/*     */   private void sendJoin() {
/* 513 */     sendControlMessage(true, (short)1);
/*     */   }
/*     */   
/*     */   private void sendLeave() {
/* 517 */     sendControlMessage(false, (short)2);
/*     */   }
/*     */   
/*     */   private void sendJoinResponse() {
/* 521 */     sendControlMessage(true, (short)7);
/*     */   }
/*     */   
/*     */   private void sendPingResponse() {
/* 525 */     sendControlMessage(true, (short)8);
/*     */   }
/*     */   
/*     */   private void sendPing() {
/* 529 */     sendControlMessage(true, (short)3);
/*     */   }
/*     */   
/*     */   private void sendControlMessage(boolean requiresAck, short controlType) {
/* 533 */     sendMessage(requiresAck, new MessageControl(controlType, this.localSenderHostPort));
/*     */   }
/*     */   
/*     */   private void sendMessage(boolean requiresAck, Message msg) {
/* 537 */     ArrayList<Message> messages = new ArrayList<Message>(1);
...
/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\cluster\mcast\McastClusterManager.class
