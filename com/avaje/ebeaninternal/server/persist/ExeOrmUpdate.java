...
/* 104 */           logger.log(Level.SEVERE, (String)null, e);
/*     */         } 
/*     */       }
/*     */     } 
/*     */   }
...
/* 141 */       pstmt = this.pstmtFactory.getPstmt(t, logSql, sql, (BatchPostExecute)request);
/*     */     } else {
/*     */       
/* 144 */       if (logSql) {
...
/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\persist\ExeOrmUpdate.class
