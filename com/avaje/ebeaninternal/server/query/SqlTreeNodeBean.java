...
/* 108 */     this(prefix, beanProp, beanProp.getTargetDescriptor(), props, myChildren, withId);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     } else {
/* 151 */       this.children = myChildren.<SqlTreeNode>toArray(new SqlTreeNode[myChildren.size()]);
/*     */     } 
/*     */     
...
/* 159 */     BeanPropertyAssocMany[] arrayOfBeanPropertyAssocMany = desc.propertiesMany();
/*     */     
/* 161 */     HashMap<String, String> m = new HashMap<String, String>();
/* 162 */     for (int i = 0; i < arrayOfBeanPropertyAssocMany.length; i++) {
/* 163 */       String name = arrayOfBeanPropertyAssocMany[i].getName();
...
/* 182 */     if (this.readId)
/* 183 */       this.idBinder.buildSelectExpressionChain(this.prefix, selectChain);  int i;
/*     */     int x;
/* 185 */     for (i = 0, x = this.properties.length; i < x; i++) {
/* 186 */       this.properties[i].buildSelectExpressionChain(this.prefix, selectChain);
/*     */     }
/*     */     
/* 189 */     for (i = 0; i < this.children.length; i++)
/*     */     {
/*     */       
...
/*     */       
/* 275 */       for (int k = 0, m = this.properties.length; k < m; k++) {
/* 276 */         this.properties[k].load(sqlBeanLoad);
/*     */       
/*     */       }
/*     */     }
/*     */     else {
/*     */       
/* 282 */       for (int k = 0, m = this.properties.length; k < m; k++) {
/*     */         
/* 284 */         BeanProperty p = localDesc.getBeanProperty(this.properties[k].getName());
/* 285 */         if (p != null) {
/* 286 */           p.load(sqlBeanLoad);
/*     */         } else {
/* 288 */           this.properties[k].loadIgnore(ctx);
/*     */         } 
/*     */       } 
/*     */     } 
/*     */     
...
/*     */ 
/*     */     
/* 305 */     for (int j = 0; j < this.children.length; j++)
/*     */     {
/*     */       
/* 308 */       this.children[j].load(ctx, localBean);
/*     */     }
/*     */     
/* 311 */     if (!lazyLoadMany)
/*     */     {
...
/*     */ 
/*     */     
/* 378 */     BeanPropertyAssocMany[] arrayOfBeanPropertyAssocMany = localDesc.propertiesMany();
/* 379 */     for (int i = 0; i < arrayOfBeanPropertyAssocMany.length; i++) {
/*     */       
/* 381 */       if (fetchedMany == null || !fetchedMany.equals(arrayOfBeanPropertyAssocMany[i])) {
/*     */ 
/*     */ 
/*     */ 
/*     */         
/* 386 */         BeanCollection<?> ref = arrayOfBeanPropertyAssocMany[i].createReferenceIfNull(localBean);
/* 387 */         if (ref != null) {
/* 388 */           ctx.register(arrayOfBeanPropertyAssocMany[i].getName(), ref);
/*     */         }
/*     */       } 
/*     */     } 
/*     */   }
...
/*     */     }
/*     */     
/* 500 */     for (i = 0; i < this.children.length; i++) {
...
/* 539 */     return "SqlTreeNodeBean: " + this.desc;
/*     */   }
/*     */ }


/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\query\SqlTreeNodeBean.class
