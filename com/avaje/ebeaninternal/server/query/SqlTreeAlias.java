...
/*  25 */   private TreeSet<String> joinProps = new TreeSet<String>();
/*     */   
/*     */   private HashSet<String> embeddedPropertyJoins;
/*     */   
/*  29 */   private TreeSet<String> manyWhereJoinProps = new TreeSet<String>();
/*     */   
/*  31 */   private HashMap<String, String> aliasMap = new HashMap<String, String>();
/*     */   
/*  33 */   private HashMap<String, String> manyWhereAliasMap = new HashMap<String, String>();
/*     */   
...
/*  55 */       this.embeddedPropertyJoins = new HashSet<String>();
/*     */     }
...
/*     */     }
/* 141 */     String s = this.aliasMap.get(prefix);
/* 142 */     if (s == null) {
...
/*     */     }
/* 156 */     String s = this.manyWhereAliasMap.get(prefix);
/* 157 */     if (s == null) {
/* 158 */       s = this.aliasMap.get(prefix);
/*     */     }
/* 160 */     if (s == null) {
...
/* 203 */     while (i.hasNext()) {
/* 204 */       Map.Entry<String, String> e = i.next();
...
/* 217 */     return "t" + ++this.counter;
/*     */   }
/*     */   
/*     */   private String nextManyWhereTableAlias() {
/* 221 */     return "u" + ++this.manyWhereCounter;
/*     */   }
/*     */ }


/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\query\SqlTreeAlias.class
