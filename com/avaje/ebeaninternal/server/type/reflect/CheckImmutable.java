...
/*  16 */     this.knownImmutable = knownImmutable;
/*     */   }
/*     */ 
/*     */   
...
/*     */ 
/*     */     
/*  38 */     Constructor[] arrayOfConstructor = (Constructor[])cls.getConstructors();
/*  39 */     for (int i = 0; i < arrayOfConstructor.length; i++) {
/*  40 */       Class<?>[] parameterTypes = arrayOfConstructor[i].getParameterTypes();
/*  41 */       if (parameterTypes.length > maxLength) {
/*  42 */         maxLength = parameterTypes.length;
/*  43 */         chosen = arrayOfConstructor[i];
/*     */       } 
/*     */     } 
/*     */     
...
/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\type\reflect\CheckImmutable.class
