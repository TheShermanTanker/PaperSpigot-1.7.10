...
/*  65 */     this.propList = new ArrayList<BeanPropertyCompoundScalar>();
/*  66 */     this.propMap = new LinkedHashMap<String, BeanPropertyCompoundScalar>();
/*     */   }
/*     */ 
/*     */   
/*     */   public BeanProperty[] getScalarProperties() {
/*  71 */     return this.propList.<BeanProperty>toArray(new BeanProperty[this.propList.size()]);
/*     */   }
/*     */   
...
/*  80 */     return this.propMap.get(propName);
/*     */   }
/*     */   
...
/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\deploy\BeanPropertyCompoundRoot.class
