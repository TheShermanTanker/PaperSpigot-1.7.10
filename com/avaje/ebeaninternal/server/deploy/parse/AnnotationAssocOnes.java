...
/*  70 */     while (it.hasNext()) {
/*  71 */       DeployBeanProperty prop = it.next();
...
/*  80 */     ManyToOne manyToOne = get((DeployBeanProperty)prop, ManyToOne.class);
/*  81 */     if (manyToOne != null) {
/*  82 */       readManyToOne(manyToOne, (DeployBeanProperty)prop);
/*     */     }
/*  84 */     OneToOne oneToOne = get((DeployBeanProperty)prop, OneToOne.class);
/*  85 */     if (oneToOne != null) {
/*  86 */       readOneToOne(oneToOne, prop);
/*     */     }
/*  88 */     Embedded embedded = get((DeployBeanProperty)prop, Embedded.class);
/*  89 */     if (embedded != null) {
/*  90 */       readEmbedded(embedded, prop);
/*     */     }
/*  92 */     EmbeddedId emId = get((DeployBeanProperty)prop, EmbeddedId.class);
/*  93 */     if (emId != null) {
/*  94 */       prop.setEmbedded(true);
/*  95 */       prop.setId(true);
/*  96 */       prop.setNullable(false);
/*     */     } 
/*  98 */     Column column = get((DeployBeanProperty)prop, Column.class);
...
/*     */ 
/*     */     
/* 106 */     Id id = get((DeployBeanProperty)prop, Id.class);
/* 107 */     if (id != null) {
...
/*     */     } 
/*     */     
/* 113 */     Where where = get((DeployBeanProperty)prop, Where.class);
/* 114 */     if (where != null)
/*     */     {
/* 116 */       prop.setExtraWhere(where.clause());
/*     */     }
/*     */     
/* 119 */     NotNull notNull = get((DeployBeanProperty)prop, NotNull.class);
/* 120 */     if (notNull != null) {
...
/* 128 */     JoinColumn joinColumn = get((DeployBeanProperty)prop, JoinColumn.class);
...
/*     */     } 
/*     */     
/* 136 */     JoinColumns joinColumns = get((DeployBeanProperty)prop, JoinColumns.class);
/* 137 */     if (joinColumns != null) {
/* 138 */       prop.getTableJoin().addJoinColumn(false, joinColumns.value(), beanTable);
/*     */     }
/*     */     
/* 141 */     JoinTable joinTable = get((DeployBeanProperty)prop, JoinTable.class);
...
/* 170 */     return "Error with association to [" + type + "] from [" + from + "]. Is " + type + " registered?";
/*     */   }
/*     */ 
/*     */   
...
/*     */     
/* 220 */     EmbeddedColumns columns = get((DeployBeanProperty)prop, EmbeddedColumns.class);
/* 221 */     if (columns != null) {
/*     */ 
/*     */       
...
/*     */     } 
/*     */     
/* 230 */     AttributeOverrides attrOverrides = get((DeployBeanProperty)prop, AttributeOverrides.class);
...
/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\deploy\parse\AnnotationAssocOnes.class
