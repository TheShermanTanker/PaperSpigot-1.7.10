...
/*  68 */     while (it.hasNext()) {
/*  69 */       DeployBeanProperty prop = it.next();
...
/*  78 */     OneToMany oneToMany = get((DeployBeanProperty)prop, OneToMany.class);
/*  79 */     if (oneToMany != null) {
/*  80 */       readToOne(oneToMany, prop);
/*  81 */       PrivateOwned privateOwned = get((DeployBeanProperty)prop, PrivateOwned.class);
...
/*     */       } 
/*     */     } 
/*  87 */     ManyToMany manyToMany = get((DeployBeanProperty)prop, ManyToMany.class);
/*  88 */     if (manyToMany != null) {
/*  89 */       readToMany(manyToMany, prop);
/*     */     }
/*     */     
/*  92 */     OrderBy orderBy = get((DeployBeanProperty)prop, OrderBy.class);
/*  93 */     if (orderBy != null) {
/*  94 */       prop.setFetchOrderBy(orderBy.value());
/*     */     }
/*     */     
/*  97 */     MapKey mapKey = get((DeployBeanProperty)prop, MapKey.class);
/*  98 */     if (mapKey != null) {
/*  99 */       prop.setMapKey(mapKey.name());
/*     */     }
/*     */     
/* 102 */     Where where = get((DeployBeanProperty)prop, Where.class);
/* 103 */     if (where != null) {
...
/* 109 */     JoinColumn joinColumn = get((DeployBeanProperty)prop, JoinColumn.class);
/* 110 */     if (joinColumn != null) {
/* 111 */       prop.getTableJoin().addJoinColumn(true, joinColumn, beanTable);
/*     */     }
/*     */     
/* 114 */     JoinColumns joinColumns = get((DeployBeanProperty)prop, JoinColumns.class);
/* 115 */     if (joinColumns != null) {
/* 116 */       prop.getTableJoin().addJoinColumn(true, joinColumns.value(), beanTable);
/*     */     }
/*     */     
/* 119 */     JoinTable joinTable = get((DeployBeanProperty)prop, JoinTable.class);
...
/*     */       } 
/*     */     }
/* 130 */     LdapAttribute ldapAttribute = get((DeployBeanProperty)prop, LdapAttribute.class);
/* 131 */     if (ldapAttribute != null)
/*     */     {
/* 133 */       readLdapAttribute(ldapAttribute, (DeployBeanProperty)prop);
/*     */     }
/*     */     
...
/* 282 */     return "Error with association to [" + type + "] from [" + from + "]. Is " + type + " registered?";
/*     */   }
/*     */ 
/*     */   
...
/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\deploy\parse\AnnotationAssocManys.class
