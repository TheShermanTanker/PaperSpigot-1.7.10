...
/* 108 */       DeployBeanProperty prop = it.next();
...
/* 124 */     Id id = get(prop, Id.class);
/* 125 */     if (id != null) {
/* 126 */       prop.setId(true);
/* 127 */       prop.setNullable(false);
/*     */     } 
/*     */     
/* 130 */     EmbeddedId embeddedId = get(prop, EmbeddedId.class);
...
/* 143 */     Enumerated enumerated = get(prop, Enumerated.class);
...
/*     */     
/* 154 */     Column column = get(prop, Column.class);
/* 155 */     if (column != null) {
/* 156 */       readColumn(column, prop);
/*     */     }
/* 158 */     LdapAttribute ldapAttribute = get(prop, LdapAttribute.class);
...
/*     */     }
/*     */     
/* 176 */     GeneratedValue gen = get(prop, GeneratedValue.class);
/* 177 */     if (gen != null) {
/* 178 */       readGenValue(gen, prop);
/*     */     }
/*     */     
/* 181 */     Id id = get(prop, Id.class);
/* 182 */     if (id != null) {
/* 183 */       readId(id, prop);
/*     */     }
/* 185 */     LdapId ldapId = get(prop, LdapId.class);
/* 186 */     if (ldapId != null) {
/* 187 */       prop.setId(true);
...
/*     */ 
/*     */     
/* 194 */     Lob lob = get(prop, Lob.class);
/* 195 */     Temporal temporal = get(prop, Temporal.class);
...
/*     */     } 
/*     */     
/* 203 */     Formula formula = get(prop, Formula.class);
/* 204 */     if (formula != null) {
/* 205 */       prop.setSqlFormula(formula.select(), formula.join());
/*     */     }
/*     */     
/* 208 */     Version version = get(prop, Version.class);
/* 209 */     if (version != null) {
/*     */       
...
/*     */     } 
/*     */     
/* 215 */     Basic basic = get(prop, Basic.class);
/* 216 */     if (basic != null) {
...
/*     */     } 
/*     */     
/* 226 */     CreatedTimestamp ct = get(prop, CreatedTimestamp.class);
/* 227 */     if (ct != null) {
/* 228 */       this.generatedPropFactory.setInsertTimestamp(prop);
/*     */     }
/*     */     
/* 231 */     UpdatedTimestamp ut = get(prop, UpdatedTimestamp.class);
/* 232 */     if (ut != null) {
/* 233 */       this.generatedPropFactory.setUpdateTimestamp(prop);
/*     */     }
/*     */     
/* 236 */     NotNull notNull = get(prop, NotNull.class);
/* 237 */     if (notNull != null)
/*     */     {
/* 239 */       prop.setNullable(false);
/*     */     }
/*     */     
/* 242 */     Length length = get(prop, Length.class);
/* 243 */     if (length != null && 
...
/*     */ 
/*     */     
/* 250 */     EmbeddedColumns columns = get(prop, EmbeddedColumns.class);
/* 251 */     if (columns != null) {
...
/*     */ 
/*     */     
/* 272 */     Transient t = get(prop, Transient.class);
/* 273 */     if (t != null) {
/*     */       
...
/* 285 */         Encrypted encrypted = get(prop, Encrypted.class);
...
/* 306 */       prop.setScalarType((ScalarType)LDAP_BOOLEAN_SCALARTYPE);
/*     */     } else {
/*     */       
...
/* 311 */       if (sqlType == 93) {
/*     */         
/* 313 */         prop.setScalarType((ScalarType)new ScalarTypeLdapTimestamp(sqlScalarType));
/*     */       }
/* 315 */       else if (sqlType == 91) {
/*     */         
/* 317 */         prop.setScalarType((ScalarType)new ScalarTypeLdapDate(sqlScalarType));
/*     */       } 
/*     */     } 
/*     */   }
/*     */ 
...
/* 337 */       prop.setScalarType((ScalarType)encryptedScalarType);
...
/*     */       } 
/*     */     } 
/* 358 */     prop.setScalarType((ScalarType)createScalarType(prop, st));
...
/*     */     
/* 394 */     if (prop.getPropertyType().equals(UUID.class))
/*     */     {
...
/*     */     
/* 409 */     SequenceGenerator sequenceGenerator = find(prop, SequenceGenerator.class);
...
/* 428 */       prop.getPropertyType().equals(UUID.class)) {
...
/* 516 */         this.util.createValidator(prop, (Annotation)patternsArray[i]);
/*     */       }
/*     */     }
/*     */     else {
/*     */       
/* 521 */       ValidatorMeta meta = type.<ValidatorMeta>getAnnotation(ValidatorMeta.class);
/* 522 */       if (meta != null)
...
/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\deploy\parse\AnnotationFields.class
