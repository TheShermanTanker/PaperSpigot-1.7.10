...
/*  40 */     this.list = list;
/*  41 */     this.chain = list.<BeanPersistListener<T>>toArray((BeanPersistListener<T>[])new BeanPersistListener[list.size()]);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\deploy\ChainedBeanPersistListener.class
