...
/*  60 */     this.enhanceContext = new EnhanceContext((ClassBytesReader)reader, true, "debug=" + logLevel);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */       
/*  85 */       Class<?> newCls = defineClass(subClsName, newClsBytes, 0, newClsBytes.length);
/*  86 */       return newCls;
/*     */     }
...
/*     */     
/* 118 */     SubClassClassAdpater ca = new SubClassClassAdpater(subClassSuffix, (ClassVisitor)cw, this.parentClassLoader, this.enhanceContext);
/* 119 */     if (ca.isLog(1)) {
/* 120 */       ca.log(" enhancing " + className + subClassSuffix);
/*     */     }
/*     */     
/* 123 */     cr.accept((ClassVisitor)ca, 0);
/*     */     
...
/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\subclass\SubClassFactory.class
