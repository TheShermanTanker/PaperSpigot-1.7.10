...
/*  34 */     visitInheritanceProperties(descriptor, this.pv);
/*     */   }
/*     */ 
/*     */   
...
/*  41 */     this.ctx.addIntersectionFkeys();
/*     */   }
/*     */   
...
/*     */       }
/*  85 */       this.ctx.write("foreign key ("); int i;
...
/* 122 */         for (int j = 0; j < columns.length; j++) {
/* 123 */           if (j > 0) {
/* 124 */             this.ctx.write(",");
/*     */           }
/* 126 */           this.ctx.write(columns[j].getLocalDbColumn());
/*     */         } 
...
/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\ddl\AddForeignKeysVisitor.class
