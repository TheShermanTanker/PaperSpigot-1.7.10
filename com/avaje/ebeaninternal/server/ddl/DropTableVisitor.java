...
/* 54 */     BeanPropertyAssocMany[] arrayOfBeanPropertyAssocMany = descriptor.propertiesMany();
/* 55 */     for (int i = 0; i < arrayOfBeanPropertyAssocMany.length; i++) {
/* 56 */       if (arrayOfBeanPropertyAssocMany[i].isManyToMany()) {
/* 57 */         String intTable = arrayOfBeanPropertyAssocMany[i].getIntersectionTableJoin().getTable();
...
/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\ddl\DropTableVisitor.class
