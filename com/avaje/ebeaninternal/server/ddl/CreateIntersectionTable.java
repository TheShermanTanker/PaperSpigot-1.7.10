...
/*  24 */   private StringBuilder sb = new StringBuilder();
/*     */   
/*  26 */   private StringBuilder pkeySb = new StringBuilder();
/*     */   
...
/* 140 */     for (int j = 0; j < otherColumns.length; j++)
/*     */     {
/* 142 */       addColumn(targetDesc, otherColumns[j].getLocalDbColumn(), otherColumns[j].getForeignDbColumn());
/*     */     }
/*     */     
...
/* 171 */     this.sb.append("  ").append(this.ctx.pad(columnName, 30)).append(" ");
/*     */   }
/*     */ }


/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\ddl\CreateIntersectionTable.class
