...
/* 112 */     return countOccurances(content, occurs, 0, 0);
/*     */   }
/*     */   
...
/*     */       
/* 210 */       String str = allNameValuePairs.substring(pos, delimPos);
/* 211 */       str = str.trim();
/* 212 */       if (str.length() > 0) {
/* 213 */         map.put(str, null);
/*     */       }
...
/* 264 */     return list.<String>toArray(result);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 499 */     return replaceStringMulti(source, match, replace, 30, 0, source.length());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 516 */     for (int i = 0; i < match0.length; i++) {
...
/*     */     
/* 536 */     for (int j = startPos; j < len; j++) {
/* 537 */       char sourceChar = source.charAt(j);
/* 538 */       if (j > lastMatch) {
...
/* 544 */             match[k].length() + j <= len) {
/*     */             
/* 546 */             matchCount++;
/* 547 */             int m = 1;
/* 548 */             for (; m < match[k].length(); m++) {
/* 549 */               if (source.charAt(j + m) != match[k].charAt(m)) {
/* 550 */                 matchCount--;
/*     */                 break;
/*     */               } 
/*     */             } 
...
/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebeaninternal\server\li\\util\StringHelper.class
