...
/*  34 */     Validator validator = cache.get(key);
/*  35 */     if (validator != null) {
/*  36 */       return validator;
/*     */     }
/*  38 */     if (type.equals(String.class)) {
/*  39 */       validator = new StringValidator(min, max);
/*     */     }
/*  41 */     else if (useDouble(type)) {
/*  42 */       validator = new DoubleValidator(min, max);
/*     */     }
/*  44 */     else if (useLong(type)) {
/*  45 */       validator = new LongValidator(min, max);
/*     */     } else {
/*     */       
...
/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebean\validation\factory\RangeValidatorFactory.class
