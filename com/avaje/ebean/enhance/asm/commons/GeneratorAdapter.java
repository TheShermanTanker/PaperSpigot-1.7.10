...
/*  285 */     this(access, method, cv.visitMethod(access, method.getName(), method.getDescriptor(), signature, getInternalNames(exceptions)));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  484 */     this.mv.visitVarInsn(type.getOpcode(21), index);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  495 */     this.mv.visitVarInsn(type.getOpcode(54), index);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  514 */     loadInsn(this.argumentTypes[arg], getArgIndex(arg));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  537 */     loadArgs(0, this.argumentTypes.length);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  563 */     storeInsn(this.argumentTypes[arg], getArgIndex(arg));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  578 */     return this.localTypes.get(local - this.firstLocal);
/*      */   }
/*      */   
...
/*  596 */     loadInsn(getLocalType(local), local);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  619 */     storeInsn(getLocalType(local), local);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  641 */     this.mv.visitInsn(type.getOpcode(46));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  650 */     this.mv.visitInsn(type.getOpcode(79));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  758 */     this.mv.visitInsn(type.getOpcode(op));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  777 */     this.mv.visitIincInsn(local, amount);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1048 */     ifCmp(Type.INT_TYPE, mode, label);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1060 */     this.mv.visitJumpInsn(mode, label);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1070 */     this.mv.visitJumpInsn(198, label);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1080 */     this.mv.visitJumpInsn(199, label);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1089 */     this.mv.visitJumpInsn(167, label);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1099 */     this.mv.visitVarInsn(169, local);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1135 */     for (int i = 1; i < keys.length; i++) {
...
/* 1149 */         Arrays.fill((Object[])labels, def); int j;
/* 1150 */         for (j = 0; j < len; j++) {
/* 1151 */           labels[keys[j] - min] = newLabel();
/*      */         }
/* 1153 */         this.mv.visitTableSwitchInsn(min, max, def, labels);
/* 1154 */         for (j = 0; j < range; j++) {
/* 1155 */           Label label = labels[j];
/* 1156 */           if (label != def) {
/* 1157 */             mark(label);
/* 1158 */             generator.generateCase(j + min, end);
/*      */           } 
/*      */         } 
/*      */       } else {
/* 1162 */         Label[] labels = new Label[len]; int j;
/* 1163 */         for (j = 0; j < len; j++) {
/* 1164 */           labels[j] = newLabel();
/*      */         }
/* 1166 */         this.mv.visitLookupSwitchInsn(def, keys, labels);
/* 1167 */         for (j = 0; j < len; j++) {
/* 1168 */           mark(labels[j]);
/* 1169 */           generator.generateCase(keys[j], end);
/*      */         } 
/*      */       } 
/*      */     } 
/* 1173 */     mark(def);
...
/* 1182 */     this.mv.visitInsn(this.returnType.getOpcode(172));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1203 */     this.mv.visitFieldInsn(opcode, ownerType.getInternalName(), name, fieldType.getDescriptor());
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1219 */     fieldInsn(178, owner, name, type);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1231 */     fieldInsn(179, owner, name, type);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1243 */     fieldInsn(180, owner, name, type);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1255 */     fieldInsn(181, owner, name, type);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1290 */     invokeInsn(182, owner, method);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1300 */     invokeInsn(183, type, method);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1310 */     invokeInsn(184, owner, method);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1320 */     invokeInsn(185, owner, method);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1334 */     this.mv.visitTypeInsn(opcode, type.getInternalName());
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1481 */     this.mv.visitTryCatchBlock(start, end, mark(), exception.getInternalName());
/*      */   }
/*      */ }


/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebean\enhance\asm\commons\GeneratorAdapter.class
