...
/* 100 */       this.branches = new HashMap<Object, Object>();
/*     */     } else {
...
/* 435 */       Object type; Type[] types = Type.getArgumentTypes(desc);
...
/* 551 */     return this.stackFrame.remove(this.stackFrame.size() - 1);
/*     */   }
/*     */   
/*     */   private Object peekValue() {
/* 555 */     return this.stackFrame.get(this.stackFrame.size() - 1);
/*     */   }
/*     */   
/*     */   private void pushValue(Object o) {
/* 559 */     this.stackFrame.add(o);
/*     */   }
/*     */   
...
/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebean\enhance\asm\commons\AdviceAdapter.class
