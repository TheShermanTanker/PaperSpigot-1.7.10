...
/*  217 */     return readUnsignedShort(this.header);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  229 */     return readClass(this.header + 2, new char[this.maxStringLength]);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  281 */       int nameType; String s; int index = this.items[i];
...
/*  369 */     this(ClassLoader.getSystemResourceAsStream(name.replace('.', '/') + ".class"));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     } 
/*      */     
/*  475 */     boolean skipCode = ((flags & 0x1) != 0);
...
/* 1139 */           int label, min, max; Label[] table; int[] keys; Label[] values; int cpIndex; String iowner, iname, idesc; w = v - codeStart;
/*      */           
/* 1141 */           Label label1 = labels[w];
/* 1142 */           if (label1 != null) {
/* 1143 */             mv.visitLabel(label1);
/* 1144 */             if (!skipDebug && label1.line > 0) {
/* 1145 */               mv.visitLineNumber(label1.line, label1);
/*      */             }
/*      */           } 
/*      */ 
/*      */           
...
/* 1403 */             int m = readUnsignedShort(varTypeTable) * 3;
/* 1404 */             w = varTypeTable + 2;
/* 1405 */             typeTable = new int[m];
/* 1406 */             while (m > 0) {
/* 1407 */               typeTable[--m] = w + 6;
/* 1408 */               typeTable[--m] = readUnsignedShort(w + 8);
/* 1409 */               typeTable[--m] = readUnsignedShort(w);
/* 1410 */               w += 10;
/*      */             } 
/*      */           } 
...
/* 1976 */     return readUTF8(this.items[readUnsignedShort(index)], buf);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebean\enhance\asm\ClassReader.class
