...
/*     */ {
/*  19 */   private static final Type BOOLEAN_OBJECT_TYPE = Type.getType(Boolean.class);
/*     */   
...
/*  26 */   private final HashSet<String> annotations = new HashSet<String>();
/*     */   
...
/* 138 */     return this.publicGetterName;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 148 */     return this.publicSetterName;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 156 */     return (this.setMethodDesc.equals(methodDesc) && isInterceptSet());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 164 */     return (this.getMethodDesc.equals(methodDesc) && isInterceptGet());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 243 */     return this.annotations.contains("Ljavax/persistence/Transient;");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */   
/*     */   public boolean isId() {
/* 253 */     boolean idField = (this.annotations.contains("Ljavax/persistence/Id;") || this.annotations.contains("Ljavax/persistence/EmbeddedId;"));
/*     */ 
/*     */ 
/*     */     
/* 257 */     return idField;
...
/* 264 */     return (this.annotations.contains("Ljavax/persistence/OneToMany;") || this.annotations.contains("Ljavax/persistence/ManyToMany;"));
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean isManyToMany() {
/* 269 */     return this.annotations.contains("Ljavax/persistence/ManyToMany;");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 276 */     return (this.annotations.contains("Ljavax/persistence/Embedded;") || this.annotations.contains("Lcom/avaje/ebean/annotation/EmbeddedColumns;"));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 285 */     return this.fieldClass.equals(classMeta.getClassName());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */       return;
/*     */     } 
/* 472 */     addPublicGetMethod(new VisitMethodParams(cv, 1, this.publicGetterName, this.getMethodDesc, null, null), classMeta);
/*     */   }
/*     */ 
/*     */   
...
/*     */       return;
/*     */     } 
/* 510 */     addPublicSetMethod(new VisitMethodParams(cv, 1, this.publicSetterName, this.setMethodDesc, null, null), classMeta);
/*     */   }
/*     */ 
/*     */   
...
/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\com\avaje\ebean\enhance\agent\FieldMeta.class
