...
/*      */     } 
/*      */   }
/*  177 */   private static Map sqlStateMessages = new HashMap<Object, Object>(); static {
...
/*      */ 
/*      */     
/*  249 */     mysqlToSqlState = new Hashtable<Object, Object>();
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/*  415 */     mysqlToSql99State = new HashMap<Object, Object>();
/*      */     
...
/*  817 */     TreeMap<Object, Object> allErrorNumbers = new TreeMap<Object, Object>();
/*  818 */     Map<Object, Object> mysqlErrorNumbersToNames = new HashMap<Object, Object>();
/*      */     
...
/*      */ 
/*      */     
/*  826 */     Iterator<Integer> iterator1 = mysqlToSql99State.keySet().iterator();
/*  827 */     while (iterator1.hasNext()) {
/*  828 */       errorNumber = iterator1.next();
/*  829 */       allErrorNumbers.put(errorNumber, errorNumber);
/*      */     } 
/*      */     
/*  832 */     Iterator<Integer> mysqlErrorNumbers = mysqlToSqlState.keySet().iterator();
/*  833 */     while (mysqlErrorNumbers.hasNext()) {
/*  834 */       errorNumber = mysqlErrorNumbers.next();
...
/*      */ 
/*      */     
/*  844 */     for (int i = 0; i < possibleFields.length; i++) {
...
/*      */     
/*  855 */     Iterator<Integer> allErrorNumbersIter = allErrorNumbers.keySet().iterator();
/*  856 */     while (allErrorNumbersIter.hasNext()) {
/*  857 */       errorNumber = allErrorNumbersIter.next();
/*      */       
...
/*  875 */     return (String)sqlStateMessages.get(stateCode);
/*      */   }
/*      */   
...
/*  927 */     return createSQLException(message, sqlState, 0, interceptor);
/*      */   }
/*      */   
/*      */   public static SQLException createSQLException(String message, ExceptionInterceptor interceptor) {
/*  931 */     return createSQLException(message, interceptor, (Connection)null);
/*      */   }
...
/*  948 */     return createSQLException(message, sqlState, cause, interceptor, (Connection)null);
/*      */   }
/*      */   
...
/*  982 */     return createSQLException(message, sqlState, vendorErrorCode, false, interceptor);
/*      */   }
/*      */ 
/*      */   
...
/*  987 */     return createSQLException(message, sqlState, vendorErrorCode, false, interceptor, null);
/*      */   }
/*      */   
...
/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\com\mysql\jdbc\SQLError.class
