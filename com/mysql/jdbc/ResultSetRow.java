...
/*      */ 
/*      */           
/*  473 */           Time adjustedTime = TimeUtil.changeTimezone(conn, sessionCalendar, targetCalendar, time, conn.getServerTimezoneTZ(), tz, rollForward);
/*      */ 
/*      */ 
/*      */           
/*  477 */           return adjustedTime;
/*      */         } 
/*      */         
...
/*      */ 
/*      */           
/*  541 */           Timestamp adjustedTs = TimeUtil.changeTimezone(conn, sessionCalendar, targetCalendar, ts, conn.getServerTimezoneTZ(), tz, rollForward);
/*      */ 
/*      */ 
/*      */           
/*  545 */           return adjustedTs;
/*      */         } 
/*      */         
...
/*  564 */     long valueAsLong = (bits[offset + 0] & 0xFF) | (bits[offset + 1] & 0xFF) << 8L | (bits[offset + 2] & 0xFF) << 16L | (bits[offset + 3] & 0xFF) << 24L | (bits[offset + 4] & 0xFF) << 32L | (bits[offset + 5] & 0xFF) << 40L | (bits[offset + 6] & 0xFF) << 48L | (bits[offset + 7] & 0xFF) << 56L;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  591 */     int valueAsInt = bits[offset + 0] & 0xFF | (bits[offset + 1] & 0xFF) << 8 | (bits[offset + 2] & 0xFF) << 16 | (bits[offset + 3] & 0xFF) << 24;
/*      */ 
/*      */ 
/*      */ 
/*      */     
/*  596 */     return valueAsInt;
/*      */   }
/*      */   
/*      */   public abstract int getNativeInt(int paramInt) throws SQLException;
/*      */   
/*      */   protected long getNativeLong(byte[] bits, int offset) {
/*  602 */     long valueAsLong = (bits[offset + 0] & 0xFF) | (bits[offset + 1] & 0xFF) << 8L | (bits[offset + 2] & 0xFF) << 16L | (bits[offset + 3] & 0xFF) << 24L | (bits[offset + 4] & 0xFF) << 32L | (bits[offset + 5] & 0xFF) << 40L | (bits[offset + 6] & 0xFF) << 48L | (bits[offset + 7] & 0xFF) << 56L;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */       
/*  651 */       Time adjustedTime = TimeUtil.changeTimezone(conn, sessionCalendar, targetCalendar, time, conn.getServerTimezoneTZ(), tz, rollForward);
/*      */ 
/*      */ 
/*      */       
/*  655 */       return adjustedTime;
/*      */     } 
/*      */   }
/*      */ 
/*      */ 
...
/*      */ 
/*      */       
/*  726 */       Timestamp adjustedTs = TimeUtil.changeTimezone(conn, sessionCalendar, targetCalendar, ts, conn.getServerTimezoneTZ(), tz, rollForward);
/*      */ 
/*      */ 
/*      */       
/*  730 */       return adjustedTs;
/*      */     } 
/*      */   }
/*      */ 
/*      */ 
...
/* 1001 */         boolean hasDash, hasColon; int j; boolean allZeroTimestamp = true;
/*      */         
...
/* 1108 */                 if (timestampAsBytes[offset + k] == 46) {
/* 1109 */                   decimalIndex = k;
/*      */                 }
/*      */               } 
/*      */               
...
/* 1181 */             hasDash = false;
/*      */             
/* 1183 */             for (j = 0; j < length; j++) {
/* 1184 */               if (timestampAsBytes[offset + j] == 45) {
/* 1185 */                 hasDash = true;
/*      */                 
/*      */                 break;
/*      */               } 
...
/* 1227 */               if (timestampAsBytes[offset + j] == 58) {
/* 1228 */                 hasColon = true;
/*      */                 
/*      */                 break;
/*      */               } 
...
/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\com\mysql\jdbc\ResultSetRow.class
