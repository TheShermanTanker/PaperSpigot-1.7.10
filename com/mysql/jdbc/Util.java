...
/*  64 */     return (systemNanoTimeMethod != null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*  72 */   private static final TimeZone DEFAULT_TIMEZONE = TimeZone.getDefault();
/*     */   
/*     */   static final TimeZone getDefaultTimeZone() {
/*  75 */     return (TimeZone)DEFAULT_TIMEZONE.clone();
/*     */   }
/*     */ 
/*     */   
...
/*     */     long seed2;
/*     */   }
/*  88 */   private static Util enclosingInstance = new Util();
/*     */   
...
/*     */ 
/*     */     
/* 116 */     String loadedFrom = stackTraceToString(new Throwable());
/*     */     
/* 118 */     if (loadedFrom != null) {
/* 119 */       isColdFusion = (loadedFrom.indexOf("coldfusion") != -1);
/*     */     } else {
...
/* 155 */       double d1 = seed1 / max;
/* 156 */       byte b1 = (byte)(int)Math.floor(d1 * 31.0D + 64.0D);
/* 157 */       chars[i] = (char)b1;
/*     */     } 
/*     */     
...
/* 249 */     enclosingInstance.getClass(); RandStructcture randStruct = new RandStructcture();
/*     */     
...
/* 500 */     Map<Object, Object> diffMap = new HashMap<Object, Object>();
/*     */     
/* 502 */     Iterator<Map.Entry> map1Entries = map1.entrySet().iterator();
/*     */     
/* 504 */     while (map1Entries.hasNext()) {
/* 505 */       Map.Entry entry = map1Entries.next();
...
/* 565 */     List<Extension> extensionList = new LinkedList();
/*     */     
/* 567 */     List interceptorsToCreate = StringUtils.split(extensionClassNames, ",", true);
/*     */ 
/*     */     
/* 570 */     Iterator<E> iter = interceptorsToCreate.iterator();
/*     */     
...
/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\com\mysql\jdbc\Util.class
