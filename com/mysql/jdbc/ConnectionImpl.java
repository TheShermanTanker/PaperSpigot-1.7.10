...
/*   99 */     return (this.proxy != null) ? this.proxy : this;
/*      */   }
/*      */   
...
/*  111 */       this.interceptors = Util.loadExtensions(ConnectionImpl.this, ConnectionImpl.this.props, interceptorClasses, "Connection.BadExceptionInterceptor", this);
/*      */     }
/*      */     
/*      */     public SQLException interceptException(SQLException sqlEx, Connection conn) {
/*  115 */       if (this.interceptors != null) {
/*  116 */         Iterator<ExceptionInterceptor> iter = this.interceptors.iterator();
/*      */         
...
/*  128 */         Iterator<ExceptionInterceptor> iter = this.interceptors.iterator();
/*      */         
...
/*  139 */         Iterator<ExceptionInterceptor> iter = this.interceptors.iterator();
/*      */         
...
/*      */ 
/*      */   
/*  232 */   private static final Log NULL_LOGGER = (Log)new NullLogger("MySQL");
/*      */   
/*      */   private static Map roundRobinStatsMap;
/*      */   
/*  236 */   private static final Map serverCollationByUrl = new HashMap<Object, Object>();
/*      */   
/*  238 */   private static final Map serverConfigByUrl = new HashMap<Object, Object>();
/*      */   
...
/*      */   
/*      */   static {
/*  256 */     mapTransIsolationNameToValue = new HashMap<Object, Object>(8);
...
/*      */       
/*      */       try {
/*  346 */         Constructor<Timer> ctr = Timer.class.getConstructor(new Class[] { String.class, boolean.class });
/*      */         
/*  348 */         this.cancelTimer = ctr.newInstance(new Object[] { "MySQL Statement Cancellation Timer", Boolean.TRUE });
...
/*      */     
/*  391 */     int index = (int)(Math.random() * indexRange);
/*      */     
/*  393 */     return index;
/*      */   }
/*      */   
...
/*      */ 
/*      */   
/*  430 */   private Map charsetConverterMap = new HashMap<Object, Object>(CharsetMapping.getNumberOfCharsetsConfigured());
/*      */ 
/*      */ 
/*      */ 
/*      */   
...
/*      */   
/*  522 */   private long minimumNumberTablesAccessed = Long.MAX_VALUE;
/*      */ 
/*      */   
...
/*  838 */     ArrayList<StatementInterceptorV2> unSafedStatementInterceptors = new ArrayList(this.statementInterceptors.size());
/*      */     
/*  840 */     for (int i = 0; i < this.statementInterceptors.size(); i++) {
/*  841 */       NoSubInterceptorWrapper wrappedInterceptor = this.statementInterceptors.get(i);
/*      */       
...
/*  882 */     return this.statementInterceptors;
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*      */     
/*  905 */     addToHistogram(this.perfMetricsHistCounts, this.perfMetricsHistBreakpoints, value, numberOfTimes, (this.shortestQueryTimeMs == Long.MAX_VALUE) ? 0L : this.shortestQueryTimeMs, this.longestQueryTimeMs);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/*  914 */     addToHistogram(this.numTablesMetricsHistCounts, this.numTablesMetricsHistBreakpoints, value, numberOfTimes, (this.minimumNumberTablesAccessed == Long.MAX_VALUE) ? 0L : this.minimumNumberTablesAccessed, this.maximumNumberTablesAccessed);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */       
/*  931 */       TreeMap<Object, Object> sortedCollationMap = null;
/*      */       
...
/*  945 */           sortedCollationMap = new TreeMap<Object, Object>();
/*      */           
...
/*      */         
/*  978 */         for (int i = 0; i < CharsetMapping.INDEX_TO_CHARSET.length; i++) {
/*  979 */           this.indexToCharsetMapping[i] = CharsetMapping.INDEX_TO_CHARSET[i];
/*      */         }
/*      */         
/*  982 */         Iterator<Map.Entry> indexIter = sortedCollationMap.entrySet().iterator();
/*  983 */         while (indexIter.hasNext()) {
/*  984 */           Map.Entry indexEntry = indexIter.next();
/*      */           
...
/* 1173 */     return (mysqlEncodingName != null && mysqlEncodingName.equalsIgnoreCase((String)this.serverVariables.get("character_set_client")) && mysqlEncodingName.equalsIgnoreCase((String)this.serverVariables.get("character_set_connection")));
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/* 1381 */     this.hasTriedMasterFlag = false;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1406 */     return clientPrepareStatement(sql, 1003, 1007);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1439 */     return clientPrepareStatement(sql, resultSetType, resultSetConcurrency, true);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1466 */               Iterator<String> oldestIter = this.cachedPreparedStatementParams.keySet().iterator();
/*      */               
/* 1468 */               long lruTime = Long.MAX_VALUE;
/* 1469 */               String oldestSql = null;
/*      */               
/* 1471 */               while (oldestIter.hasNext()) {
/* 1472 */                 String sqlKey = oldestIter.next();
...
/* 1540 */     return clientPrepareStatement(sql, resultSetType, resultSetConcurrency, true);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     }
/*      */     
/* 1564 */     realClose(true, true, false, (Throwable)null);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1577 */       List<StatementImpl> currentlyOpenStatements = new ArrayList();
/*      */ 
/*      */ 
/*      */       
...
/* 1589 */         StatementImpl stmt = currentlyOpenStatements.get(i);
/*      */         
/*      */         try {
...
/*      */ 
/*      */           
/* 1663 */           execSQL((StatementImpl)null, "commit", -1, (Buffer)null, 1003, 1007, false, this.database, (Field[])null, false);
/*      */         
/*      */         }
/*      */ 
/*      */       
...
/*      */                 {
/* 1832 */                   execSQL((StatementImpl)null, "SET NAMES " + (useutf8mb4 ? "utf8mb4" : "utf8"), -1, (Buffer)null, 1003, 1007, false, this.database, (Field[])null, false);
/*      */                 
/*      */                 }
/*      */               }
/*      */               else {
/*      */                 
/* 1838 */                 execSQL((StatementImpl)null, "SET NAMES latin1", -1, (Buffer)null, 1003, 1007, false, this.database, (Field[])null, false);
/*      */               } 
/*      */ 
/*      */ 
/*      */ 
...
/* 1864 */                   execSQL((StatementImpl)null, "SET NAMES " + mysqlEncodingName, -1, (Buffer)null, 1003, 1007, false, this.database, (Field[])null, false);
/*      */                 }
/*      */               }
/*      */ 
/*      */ 
...
/* 1890 */               execSQL((StatementImpl)null, "SET NAMES " + mysqlEncodingName, -1, (Buffer)null, 1003, 1007, false, this.database, (Field[])null, false);
/*      */             }
/*      */ 
/*      */ 
/*      */ 
...
/* 1924 */             execSQL((StatementImpl)null, "SET character_set_results = NULL", -1, (Buffer)null, 1003, 1007, false, this.database, (Field[])null, false);
/*      */ 
/*      */ 
/*      */ 
/*      */             
...
/* 1940 */             execSQL((StatementImpl)null, "SET NAMES latin1", -1, (Buffer)null, 1003, 1007, false, this.database, (Field[])null, false);
/*      */           }
/*      */ 
/*      */ 
/*      */           
...
/*      */ 
/*      */             
/* 1969 */             execSQL((StatementImpl)null, setBuf.toString(), -1, (Buffer)null, 1003, 1007, false, this.database, (Field[])null, false);
/*      */ 
/*      */ 
/*      */ 
/*      */             
...
/*      */ 
/*      */           
/* 1992 */           execSQL((StatementImpl)null, setBuf.toString(), -1, (Buffer)null, 1003, 1007, false, this.database, (Field[])null, false);
/*      */         
/*      */         }
/*      */       
/*      */       }
...
/* 2231 */           } catch (InterruptedException IE) {}
/*      */         }
/*      */       } 
/*      */     } 
/*      */ 
...
/*      */ 
/*      */       
/* 2269 */       Stack<Object> serverPreparedStatements = null;
/*      */       
...
/*      */       
/* 2326 */       if (parsedHostPortPair[1] != null) {
...
/*      */     
/* 2425 */     this.cachedPreparedStatementParams = new HashMap<Object, Object>(cacheSize);
/*      */     
...
/* 2467 */     return createStatement(1003, 1007);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 2512 */     System.err.println(query);
/*      */   }
/*      */   
/*      */   public Connection duplicate() throws SQLException {
/* 2516 */     return new ConnectionImpl(this.origHostToConnectTo, this.origPortToConnectTo, this.props, this.origDatabaseToConnectTo, this.myURL);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 2570 */     return execSQL(callingStatement, sql, maxRows, packet, resultSetType, resultSetConcurrency, streamResults, catalog, cachedMetadata, false);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 2807 */     return this.characterSetMetadata;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 2917 */     return this.defaultTimeZone;
/*      */   }
/*      */   
/*      */   public String getErrorMessageEncoding() {
/* 2921 */     return this.errorMessageEncoding;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 2949 */     long idleTime = now - this.lastQueryFinishedTime;
/*      */     
/* 2951 */     return idleTime;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 3065 */     return getMetaData(true, true);
/*      */   }
/*      */   
...
/* 3115 */     return this.netBufferLength;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 3132 */     return this.io.getServerMajorVersion();
/*      */   }
/*      */   
/*      */   public int getServerMinorVersion() {
/* 3136 */     return this.io.getServerMinorVersion();
/*      */   }
/*      */   
/*      */   public int getServerSubMinorVersion() {
/* 3140 */     return this.io.getServerSubMinorVersion();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 3149 */     return this.serverTimezoneTZ;
/*      */   }
/*      */ 
/*      */   
...
/* 3162 */     return this.io.getServerVersion();
/*      */   }
/*      */ 
/*      */   
/*      */   public Calendar getSessionLockedCalendar() {
/* 3167 */     return this.sessionCalendar;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 3260 */       this.typeMap = new HashMap<Object, Object>();
/*      */     }
/*      */     
...
/* 3267 */     return this.myURL;
/*      */   }
/*      */   
/*      */   public String getUser() {
/* 3271 */     return this.user;
/*      */   }
/*      */   
/*      */   public Calendar getUtcCalendar() {
/* 3275 */     return this.utcCalendar;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 3292 */     return this.props.equals(c.getProperties());
/*      */   }
/*      */   
/*      */   public Properties getProperties() {
/* 3296 */     return this.props;
/*      */   }
/*      */   
/*      */   public boolean hasTriedMaster() {
/* 3300 */     return this.hasTriedMasterFlag;
/*      */   }
/*      */   
...
/* 3616 */     return ("ON".equalsIgnoreCase((String)this.serverVariables.get("query_cache_type")) && !"0".equalsIgnoreCase((String)this.serverVariables.get("query_cache_size")));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 3698 */     return this.isClientTzUTC;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 3707 */     return this.isClosed;
/*      */   }
/*      */   
/*      */   public boolean isCursorFetchEnabled() throws SQLException {
/* 3711 */     return (versionMeetsMinimum(5, 0, 2) && getUseCursorFetch());
/*      */   }
/*      */   
/*      */   public boolean isInGlobalTx() {
/* 3715 */     return this.isInGlobalTx;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 3736 */     return this.noBackslashEscapes;
/*      */   }
/*      */   
/*      */   public boolean isReadInfoMsgEnabled() {
/* 3740 */     return this.readInfoMsg;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 3753 */     return this.readOnly;
/*      */   }
/*      */   
/*      */   public boolean isRunningOnJDK13() {
/* 3757 */     return this.isRunningOnJDK13;
/*      */   }
/*      */   
...
/* 3808 */     return this.isServerTzUTC;
/*      */   }
/*      */   
/* 3811 */   protected ConnectionImpl() { this.usingCachedConfig = false;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/* 3955 */         this.statementsUsingMaxRows = new HashMap<Object, Object>();
/*      */       }
/*      */       
...
/* 4018 */     return this.parserKnowsUnicode;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 4066 */     return prepareCall(sql, 1003, 1007);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/* 4136 */     CallableStatement cStmt = (CallableStatement)prepareCall(sql, resultSetType, resultSetConcurrency);
/*      */ 
/*      */     
/* 4139 */     return cStmt;
/*      */   }
...
/* 4169 */     return prepareStatement(sql, 1003, 1007);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */             
/* 4357 */             this.eventSink.consumeEvent(new ProfilerEvent((byte)0, "", getCatalog(), getId(), -1, -1, System.currentTimeMillis(), 0L, Constants.MILLIS_I18N, null, this.pointOfOrigin, message));
/*      */           } 
/*      */ 
/*      */ 
/*      */ 
...
/*      */             
/* 4371 */             this.eventSink.consumeEvent(new ProfilerEvent((byte)0, "", getCatalog(), getId(), -1, -1, System.currentTimeMillis(), 0L, Constants.MILLIS_I18N, null, this.pointOfOrigin, message));
/*      */           } 
/*      */         } 
/*      */ 
/*      */ 
...
/*      */     
/* 4504 */     repartitionHistogram(this.perfMetricsHistCounts, this.perfMetricsHistBreakpoints, (this.shortestQueryTimeMs == Long.MAX_VALUE) ? 0L : this.shortestQueryTimeMs, this.longestQueryTimeMs);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/* 4513 */     repartitionHistogram(this.numTablesMetricsHistCounts, this.numTablesMetricsHistBreakpoints, (this.minimumNumberTablesAccessed == Long.MAX_VALUE) ? 0L : this.minimumNumberTablesAccessed, this.maximumNumberTablesAccessed);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 4522 */       StringBuffer logMessage = new StringBuffer(256);
/*      */       
...
/*      */ 
/*      */     
/* 4854 */     execSQL((StatementImpl)null, "rollback", -1, (Buffer)null, 1003, 1007, false, this.database, (Field[])null, false);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 4949 */     return versionMeetsMinimum(4, 0, 2);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 5022 */             execSQL((StatementImpl)null, autoCommitFlag ? "SET autocommit=1" : "SET autocommit=0", -1, (Buffer)null, 1003, 1007, false, this.database, (Field[])null, false);
/*      */           
/*      */           }
/*      */         
/*      */         }
...
/*      */       
/* 5116 */       execSQL((StatementImpl)null, query.toString(), -1, (Buffer)null, 1003, 1007, false, this.database, (Field[])null, false);
/*      */ 
/*      */ 
/*      */ 
/*      */       
...
/* 5174 */     this.readOnly = readOnlyFlag;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 5230 */       List<String> variablesToSet = StringUtils.split(getSessionVariables(), ",", "\"'", "\"'", false);
/*      */ 
/*      */       
...
/* 5241 */           String variableValuePair = variablesToSet.get(i);
/*      */           
...
/*      */ 
/*      */         
/* 5318 */         execSQL((StatementImpl)null, sql, -1, (Buffer)null, 1003, 1007, false, this.database, (Field[])null, false);
/*      */ 
/*      */ 
/*      */ 
/*      */         
...
/*      */         
/* 5364 */         execSQL((StatementImpl)null, commandBuf.toString(), -1, (Buffer)null, 1003, 1007, false, this.database, (Field[])null, false);
/*      */ 
/*      */ 
/*      */ 
/*      */         
...
/* 5406 */     return this.hasIsolationLevels;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 5415 */     return this.hasQuotedIdentifiers;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 5424 */     return this.transactionsSupported;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */           
/* 5458 */           execSQL((StatementImpl)null, "SET OPTION SQL_SELECT_LIMIT=DEFAULT", -1, (Buffer)null, 1003, 1007, false, this.database, (Field[])null, false);
/*      */ 
/*      */ 
/*      */ 
/*      */           
...
/* 5470 */     return this.useAnsiQuotes;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 5569 */     return this.statementComment;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 5581 */     this.statementComment = comment;
/*      */   }
/*      */   
...
/* 5633 */     return this.storesLowerCaseTableName;
/*      */   }
/*      */ 
/*      */ 
/*      */   
/*      */   public ExceptionInterceptor getExceptionInterceptor() {
/* 5639 */     return this.exceptionInterceptor;
/*      */   }
/*      */   
/*      */   public boolean getRequiresEscapingEncoder() {
/* 5643 */     return this.requiresEscapingEncoder;
/*      */   }
/*      */ }


/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\com\mysql\jdbc\ConnectionImpl.class
