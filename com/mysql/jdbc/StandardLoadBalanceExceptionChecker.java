...
/*     */       {
/*  48 */         for (Iterator<E> i = this.sqlStateList.iterator(); i.hasNext();) {
...
/*  89 */     List<String> newStates = new ArrayList();
/*  90 */     Iterator<E> i = states.iterator();
/*     */     
/*  92 */     while (i.hasNext()) {
...
/* 108 */     List<Class<?>> newClasses = new ArrayList();
/* 109 */     Iterator<E> i = classes.iterator();
/*     */     
/* 111 */     while (i.hasNext()) {
...
/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\com\mysql\jdbc\StandardLoadBalanceExceptionChecker.class
