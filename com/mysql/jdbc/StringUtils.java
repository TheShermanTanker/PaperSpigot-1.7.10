...
/*      */   
/*      */   static {
/*   63 */     for (int i = -128; i <= 127; i++) {
/*   64 */       allBytes[i - -128] = (byte)i;
/*      */     }
/*      */     
/*   67 */     String allBytesString = new String(allBytes, 0, 255);
/*      */ 
/*      */     
/*   70 */     int allBytesStringLen = allBytesString.length();
/*      */     
/*   72 */     int j = 0;
/*   73 */     for (; j < 255 && j < allBytesStringLen; j++) {
/*   74 */       byteToChars[j] = allBytesString.charAt(j);
/*      */     }
/*      */     
/*      */     try {
...
/*      */     
/*  128 */     for (int i = 0; i < rows && p < length; i++) {
/*  129 */       int ptemp = p;
/*      */       int k;
/*  131 */       for (k = 0; k < 8; k++) {
...
/*  159 */     int n = 0;
/*      */     int j;
/*  161 */     for (j = p; j < length; j++) {
/*  162 */       String hexVal = Integer.toHexString(byteBuffer[j] & 0xFF);
/*      */       
...
/*      */     
/*  178 */     for (j = p; j < length; j++) {
/*  179 */       int b = 0xFF & byteBuffer[j];
/*      */       
/*  181 */       if (b > 32 && b < 127) {
...
/*  322 */     return firstNonWsCharUc(searchIn, 0);
/*      */   }
/*      */   
...
/*  738 */         c = (char)(Character.toUpperCase(c) - 65 + 10);
/*      */       } else {
/*      */         break;
/*      */       } 
/*      */       
...
/*  769 */     return getInt(buf, 0, buf.length);
/*      */   }
/*      */   
/*      */   public static long getLong(byte[] buf) throws NumberFormatException {
/*  773 */     return getLong(buf, 0, buf.length);
/*      */   }
/*      */   
...
/*  801 */     int save = s;
/*      */     
/*  803 */     long cutoff = Long.MAX_VALUE / base;
/*  804 */     long cutlim = (int)(Long.MAX_VALUE % base);
/*      */     
/*  806 */     if (negative) {
/*  807 */       cutlim++;
/*      */     }
...
/*  819 */         c = (char)(Character.toUpperCase(c) - 65 + 10);
/*      */       } else {
/*      */         break;
/*      */       } 
/*      */       
...
/*  874 */     int save = s;
/*      */     
/*  876 */     short cutoff = (short)(32767 / base);
/*  877 */     short cutlim = (short)(32767 % base);
/*      */     
/*  879 */     if (negative) {
...
/*  892 */         c = (char)(Character.toUpperCase(c) - 65 + 10);
/*      */       } else {
/*      */         break;
/*      */       } 
/*      */       
...
/*  971 */     return (Character.toLowerCase(searchIn.charAt(i)) != firstCharOfPatternLc && Character.toUpperCase(searchIn.charAt(i)) != firstCharOfPatternUc);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  986 */     return indexOfIgnoreCase(0, searchIn, searchFor);
/*      */   }
/*      */ 
/*      */ 
/*      */   
...
/*      */ 
/*      */     
/* 1080 */     List<String> splitTokens = new ArrayList(tokenizer.countTokens());
/*      */     
...
/* 1113 */       return new ArrayList<String>();
/*      */     }
/*      */     
...
/* 1175 */     return searchIn.regionMatches(true, startAt, searchFor, 0, searchFor.length());
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1191 */     return startsWithIgnoreCase(searchIn, 0, searchFor);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1240 */     return startsWithIgnoreCaseAndWs(searchIn, searchFor, 0);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1307 */     return toAsciiString(buffer, 0, buffer.length);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1550 */     return (toTest == null || toTest.length() == 0);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     } 
/*      */     
/* 1740 */     List<String> retTokens = new ArrayList(2);
/*      */ 
/*      */ 
/*      */     
...
/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\com\mysql\jdbc\StringUtils.class
