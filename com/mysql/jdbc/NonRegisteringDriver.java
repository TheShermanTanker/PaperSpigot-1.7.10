...
/* 236 */     return (parseURL(url, null) != null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/*     */     try {
/* 305 */       Connection newConn = ConnectionImpl.getInstance(host(props), port(props), props, database(props), url);
/*     */ 
/*     */       
/* 308 */       return newConn;
...
/* 314 */       SQLException sqlEx = SQLError.createSQLException(Messages.getString("NonRegisteringDriver.17") + ex.toString() + Messages.getString("NonRegisteringDriver.18"), "08001", (ExceptionInterceptor)null);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 444 */     return props.getProperty("DBNAME");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 453 */     return getMajorVersionInternal();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 462 */     return getMinorVersionInternal();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 554 */     return props.getProperty("HOST", "localhost");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 766 */         String configName = namesIter.next();
/*     */         
/*     */         try {
...
/* 782 */           SQLException sqlEx = SQLError.createSQLException("Unable to load configuration template '" + configName + "' due to underlying IOException: " + ioEx, "01S00", (ExceptionInterceptor)null);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */       } 
/*     */       
/* 794 */       Iterator<E> propsIter = urlProps.keySet().iterator();
/*     */       
...
/* 808 */       Iterator<E> propsIter = defaults.keySet().iterator();
/*     */       
...
/* 831 */     return Integer.parseInt(props.getProperty("PORT", "3306"));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 845 */     return props.getProperty(name);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */         
/* 868 */         String key = kvp.get(0);
/* 869 */         String value = (kvp.size() > 1) ? kvp.get(1) : null;
/*     */         
...
/* 896 */     return (host != null && StringUtils.startsWithIgnoreCase(host, "address="));
/*     */   }
/*     */ }


/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\com\mysql\jdbc\NonRegisteringDriver.class
