...
/*      */   
/*      */   static {
/*   81 */     HashMap<Object, Object> tempNumBytesMap = new HashMap<Object, Object>();
/*      */     
...
/*      */ 
/*      */     
/*  202 */     HashMap<Object, Object> javaToMysqlMap = new HashMap<Object, Object>();
/*      */     
...
/*      */     
/*  208 */     HashMap<Object, Object> mysqlToJavaMap = new HashMap<Object, Object>();
/*      */     
...
/*      */ 
/*      */       
/*  219 */       Iterator<VersionedStringProperty> mysqlEncodings = mysqlEncodingList.iterator();
/*      */       
/*  221 */       String mysqlEncodingName = null;
/*      */       
/*  223 */       while (mysqlEncodings.hasNext()) {
/*  224 */         VersionedStringProperty mysqlProp = mysqlEncodings.next();
/*      */         
...
/*      */     
/*  240 */     TreeMap<String, Object> ucMap = new TreeMap<String, Object>(String.CASE_INSENSITIVE_ORDER);
/*      */     
/*  242 */     Iterator<String> javaNamesKeys = JAVA_TO_MYSQL_CHARSET_MAP.keySet().iterator();
/*      */     
/*  244 */     while (javaNamesKeys.hasNext()) {
/*  245 */       String key = javaNamesKeys.next();
/*      */       
...
/*      */ 
/*      */     
/*  257 */     HashMap<Object, Object> tempMapMulti = new HashMap<Object, Object>();
/*      */     
...
/*      */       
/*      */       int j;
/*  464 */       for (j = 99; j < 128; j++) {
/*  465 */         INDEX_TO_CHARSET[j] = "ISO8859_1";
/*      */       }
/*      */       
...
/*      */ 
/*      */       
/*  507 */       for (j = 147; j < 192; j++) {
/*  508 */         INDEX_TO_CHARSET[j] = "ISO8859_1";
/*      */       }
/*      */       
...
/*      */ 
/*      */       
/*  553 */       for (j = 212; j < 224; j++) {
/*  554 */         INDEX_TO_CHARSET[j] = "ISO8859_1";
/*      */       }
/*      */       
/*  557 */       for (j = 224; j <= 243; j++) {
/*  558 */         INDEX_TO_CHARSET[j] = getJavaEncodingForMysqlEncoding("utf8", null);
/*      */       }
/*      */ 
/*      */       
/*  562 */       for (j = 101; j <= 120; j++) {
/*  563 */         INDEX_TO_CHARSET[j] = getJavaEncodingForMysqlEncoding("utf16", null);
/*      */       }
/*      */ 
/*      */       
/*  567 */       for (j = 160; j <= 179; j++) {
/*  568 */         INDEX_TO_CHARSET[j] = getJavaEncodingForMysqlEncoding("utf32", null);
/*      */       }
/*      */ 
/*      */       
/*  572 */       for (j = 244; j < 254; j++) {
/*  573 */         INDEX_TO_CHARSET[j] = "ISO8859_1";
/*      */       }
/*      */       
...
/*      */ 
/*      */       
/*  581 */       for (j = 1; j < INDEX_TO_CHARSET.length; j++) {
/*  582 */         if (INDEX_TO_CHARSET[j] == null) {
/*  583 */           throw new RuntimeException("Assertion failure: No mapping from charset index " + j + " to a Java character set");
/*      */         }
/*      */       } 
...
/*      */     
/*  817 */     Map<String, Object> indexMap = new TreeMap<String, Object>(String.CASE_INSENSITIVE_ORDER);
/*      */     
...
/*      */     
/*  829 */     Map<Object, Object> tempMap = new HashMap<Object, Object>();
/*      */     
...
/*  878 */       Iterator<VersionedStringProperty> iter = mysqlEncodings.iterator();
/*      */       
/*  880 */       VersionedStringProperty versionedProp = null;
/*      */       
/*  882 */       while (iter.hasNext()) {
/*  883 */         VersionedStringProperty propToCheck = iter.next();
/*      */ 
/*      */         
/*  886 */         if (conn == null)
/*      */         {
...
/*  920 */     return MYSQL_TO_JAVA_CHARSET_MAP.size() / 2;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  984 */     return ("SJIS".equalsIgnoreCase(encoding) || "WINDOWS-31J".equalsIgnoreCase(encoding) || "MS932".equalsIgnoreCase(encoding) || "SHIFT_JIS".equalsIgnoreCase(encoding) || "CP943".equalsIgnoreCase(encoding));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*      */   private static void populateMapWithKeyValuePairs(String configKey, Map<String, List> mapToPopulate, boolean addVersionedProperties, boolean addUppercaseKeys) {
...
/* 1008 */         Iterator<String> mappingsIter = mappings.iterator();
/*      */         
/* 1010 */         while (mappingsIter.hasNext()) {
/* 1011 */           String aMapping = mappingsIter.next();
/*      */           
/* 1013 */           List<E> parsedPair = StringUtils.split(aMapping, "=", true);
/*      */           
...
/* 1020 */               List<VersionedStringProperty> versionedProperties = (List)mapToPopulate.get(key);
/*      */ 
/*      */               
...
/*      */                 
/* 1035 */                 versionedProperties = mapToPopulate.get(keyUc);
/*      */ 
/*      */                 
/* 1038 */                 if (versionedProperties == null) {
/* 1039 */                   versionedProperties = new ArrayList<VersionedStringProperty>();
...
/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\com\mysql\jdbc\CharsetMapping.class
