...
/*    */ 
/*    */ final class DispenseBehaviorFireworks
...
/* 46 */     EntityFireworks entityfireworks = new EntityFireworks(isourceblock.k(), event.getVelocity().getX(), event.getVelocity().getY(), event.getVelocity().getZ(), itemstack1);
/*    */     
/* 48 */     isourceblock.k().addEntity(entityfireworks);
/*    */ 
/*    */ 
/*    */     
/* 52 */     return itemstack;
...
/* 56 */     isourceblock.k().triggerEffect(1002, isourceblock.getBlockX(), isourceblock.getBlockY(), isourceblock.getBlockZ(), 0);
/*    */   }
/*    */ }


/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\net\minecraft\server\v1_7_R4\DispenseBehaviorFireworks.class
