...
/*   33 */   private static final Logger bL = LogManager.getLogger();
...
/*      */   public double d;
/*      */   public double e;
/*   40 */   public final List chunkCoordIntPairQueue = new LinkedList();
/*   41 */   public final List removeQueue = new LinkedList();
/*      */   private final ServerStatisticManager bO;
/*   43 */   private float bP = Float.MIN_VALUE;
/*   44 */   private float bQ = -1.0E8F;
/*   45 */   private int bR = -99999999;
/*      */   private boolean bS = true;
/*   47 */   public int lastSentExp = -99999999;
/*   48 */   public int invulnerableTicks = 60;
/*      */   private EnumChatVisibility bV;
/*      */   private boolean bW = true;
/*   51 */   private long bX = System.currentTimeMillis();
/*      */   
...
/*   60 */   public int newExp = 0;
/*   61 */   public int newLevel = 0;
/*   62 */   public int newTotalExp = 0;
/*      */   public boolean keepLevel = false;
/*      */   public double maxHealthCache;
/*      */   public boolean joining = true;
/*   66 */   public int lastPing = -1;
/*      */   
...
/*      */   
/*      */   public boolean R() {
/*   76 */     return (this.collidesWithEntities && super.R());
/*      */   }
/*      */ 
/*      */ 
/*      */   
/*      */   public boolean S() {
/*   82 */     return (this.collidesWithEntities && super.S());
/*      */   }
/*      */   
/*      */   public EntityPlayer(MinecraftServer minecraftserver, WorldServer worldserver, GameProfile gameprofile, PlayerInteractManager playerinteractmanager)
/*      */   {
/*   87 */     super(worldserver, gameprofile);
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/* 1092 */     this.timeOffset = 0L;
/* 1093 */     this.relativeTime = true;
/*      */ 
/*      */ 
/*      */ 
/*      */ 
