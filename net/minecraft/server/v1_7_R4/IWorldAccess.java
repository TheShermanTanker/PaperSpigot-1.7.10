...
public interface IWorldAccess {
  ...
  void a(EntityHuman paramEntityHuman, String paramString, double paramDouble1, double paramDouble2, double paramDouble3, float paramFloat1, float paramFloat2);
  ...
  void a(EntityHuman paramEntityHuman, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5);
...
/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\net\minecraft\server\v1_7_R4\IWorldAccess.class
