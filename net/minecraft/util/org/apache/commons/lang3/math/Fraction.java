...
/* 550 */       return ONE; 
/* 551 */     if (power < 0) {
/* 552 */       if (power == Integer.MIN_VALUE) {
...
/*     */     
/* 595 */     int k = 0;
/* 596 */     while ((u & 0x1) == 0 && (v & 0x1) == 0 && k < 31) {
/* 597 */       u /= 2; v /= 2; k++;
/*     */     } 
/* 599 */     if (k == 31) {
...
/* 754 */     if (d1 == 1) {
/*     */       
/* 756 */       int i = mulAndCheck(this.numerator, fraction.denominator);
/* 757 */       int j = mulAndCheck(fraction.numerator, this.denominator);
/* 758 */       return new Fraction(isAdd ? addAndCheck(i, j) : subAndCheck(i, j), mulPosAndCheck(this.denominator, fraction.denominator));
/*     */     } 
/*     */ 
/*     */ 
/*     */ 
...
/* 885 */       return 0;
/*     */     }
/* 887 */     if (this.numerator == other.numerator && this.denominator == other.denominator) {
/* 888 */       return 0;
/*     */     }
/*     */ 
/*     */     
/* 892 */     long first = this.numerator * other.denominator;
/* 893 */     long second = other.numerator * this.denominator;
/* 894 */     if (first == second)
/* 895 */       return 0; 
/* 896 */     if (first < second) {
/* 897 */       return -1;
...
/* 913 */       this.toString = (new StringBuilder(32)).append(getNumerator()).append('/').append(getDenominator()).toString();
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/*     */ 
/*     */         
/* 943 */         int properNumerator = getProperNumerator();
/* 944 */         if (properNumerator == 0) {
/* 945 */           this.toProperString = Integer.toString(getProperWhole());
/*     */         } else {
/* 947 */           this.toProperString = (new StringBuilder(32)).append(getProperWhole()).append(' ').append(properNumerator).append('/').append(getDenominator()).toString();
/*     */         }
/*     */       
/*     */       }
/*     */       else {
/*     */         
/* 953 */         this.toProperString = (new StringBuilder(32)).append(getNumerator()).append('/').append(getDenominator()).toString();
/*     */       } 
/*     */     }
/*     */ 
/*     */     
...
/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\net\minecraf\\util\org\apache\commons\lang3\math\Fraction.class
