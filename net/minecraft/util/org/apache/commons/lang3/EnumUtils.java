...
/* 269 */     values = ArrayUtils.clone(Validate.<long[]>notNull(values));
/* 270 */     ArrayUtils.reverse(values);
/* 271 */     for (Enum enum_ : (Enum[])enumClass.getEnumConstants()) {
/* 272 */       int block = enum_.ordinal() / 64;
/* 273 */       if (block < values.length && (values[block] & (1 << enum_.ordinal() % 64)) != 0L) {
...
/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\net\minecraf\\util\org\apache\commons\lang3\EnumUtils.class
