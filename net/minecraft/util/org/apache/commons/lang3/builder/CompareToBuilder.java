...
/*  314 */     AccessibleObject.setAccessible((AccessibleObject[])fields, true);
/*  315 */     for (int i = 0; i < fields.length && builder.comparison == 0; i++) {
/*  316 */       Field f = fields[i];
/*  317 */       if (!ArrayUtils.contains((Object[])excludeFields, f.getName()) && f.getName().indexOf('$') == -1 && (useTransients || !Modifier.isTransient(f.getModifiers())) && !Modifier.isStatic(f.getModifiers())) {
/*      */         
/*      */         try {
/*      */ 
/*      */           
...
/*  370 */     return append(lhs, rhs, (Comparator<?>)null);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */       
/*  442 */       Comparable<Object> comparable = (Comparable<Object>)lhs;
/*  443 */       this.comparison = comparable.compareTo(rhs);
/*      */     } else {
/*      */       
/*  446 */       Comparator<Object> comparator2 = (Comparator)comparator;
...
/*      */   
/*      */   public CompareToBuilder append(Object[] lhs, Object[] rhs) {
/*  621 */     return append(lhs, rhs, (Comparator<?>)null);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\net\minecraf\\util\org\apache\commons\lang3\builder\CompareToBuilder.class
