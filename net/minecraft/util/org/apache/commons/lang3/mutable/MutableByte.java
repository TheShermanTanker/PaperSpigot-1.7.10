...
/* 138 */     this.value = (byte)(this.value + operand);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 149 */     this.value = (byte)(this.value + operand.byteValue());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 159 */     this.value = (byte)(this.value - operand);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 170 */     this.value = (byte)(this.value - operand.byteValue());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 247 */       return (this.value == ((MutableByte)obj).byteValue());
/*     */     }
/* 249 */     return false;
/*     */   }
/*     */ 
...
/* 271 */     byte anotherVal = other.value;
...
/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\net\minecraf\\util\org\apache\commons\lang3\mutable\MutableByte.class
