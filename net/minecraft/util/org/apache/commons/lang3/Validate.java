...
/*  950 */       throw new IllegalArgumentException(String.format("The value %s is not in the specified exclusive range of %s to %s", new Object[] { value, start, end }));
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1000 */     if (!type.isInstance(obj)) {
/* 1001 */       throw new IllegalArgumentException(String.format("Expected type: %s, actual: %s", new Object[] { type.getName(), (obj == null) ? "null" : obj.getClass().getName() }));
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1051 */     if (!superType.isAssignableFrom(type)) {
/* 1052 */       throw new IllegalArgumentException(String.format("Cannot assign a %s to a %s", new Object[] { (type == null) ? "null" : type.getName(), superType.getName() }));
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1076 */     if (!superType.isAssignableFrom(type))
/* 1077 */       throw new IllegalArgumentException(String.format(message, values)); 
/*      */   }
/*      */ }


/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\net\minecraf\\util\org\apache\commons\lang3\Validate.class
