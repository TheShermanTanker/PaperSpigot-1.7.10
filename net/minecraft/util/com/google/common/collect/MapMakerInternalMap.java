...
/*      */ 
/*      */       
/* 1044 */       this.previousExpirable = MapMakerInternalMap.nullEntry(); } public long getExpirationTime() { return this.time; }
...
/*      */ 
/*      */       
/* 1079 */       this.previousEvictable = MapMakerInternalMap.nullEntry(); } public MapMakerInternalMap.ReferenceEntry<K, V> getNextEvictable() {
...
/*      */ 
/*      */       
/* 1154 */       this.previousEvictable = MapMakerInternalMap.nullEntry(); } public long getExpirationTime() { return this.time; } public void setExpirationTime(long time) { this.time = time; } public MapMakerInternalMap.ReferenceEntry<K, V> getNextExpirable() { return this.nextExpirable; } public void setNextExpirable(MapMakerInternalMap.ReferenceEntry<K, V> next) { this.nextExpirable = next; }
/*      */     public MapMakerInternalMap.ReferenceEntry<K, V> getPreviousExpirable() { return this.previousExpirable; }
...
/*      */ 
/*      */       
/* 1299 */       this.previousExpirable = MapMakerInternalMap.nullEntry(); } public long getExpirationTime() { return this.time; }
/*      */     public void setExpirationTime(long time) { this.time = time; }
/*      */     public MapMakerInternalMap.ReferenceEntry<K, V> getNextExpirable() { return this.nextExpirable; }
/*      */     public void setNextExpirable(MapMakerInternalMap.ReferenceEntry<K, V> next) { this.nextExpirable = next; }
/*      */     public MapMakerInternalMap.ReferenceEntry<K, V> getPreviousExpirable() {
...
/*      */ 
/*      */       
/* 1335 */       this.previousEvictable = MapMakerInternalMap.nullEntry(); } public MapMakerInternalMap.ReferenceEntry<K, V> getNextEvictable() {
/*      */       return this.nextEvictable;
/*      */     } public void setNextEvictable(MapMakerInternalMap.ReferenceEntry<K, V> next) {
/*      */       this.nextEvictable = next;
/*      */     } public MapMakerInternalMap.ReferenceEntry<K, V> getPreviousEvictable() {
...
/*      */ 
/*      */       
/* 1411 */       this.previousEvictable = MapMakerInternalMap.nullEntry(); } public long getExpirationTime() { return this.time; } public void setExpirationTime(long time) { this.time = time; } public MapMakerInternalMap.ReferenceEntry<K, V> getNextExpirable() { return this.nextExpirable; } public void setNextExpirable(MapMakerInternalMap.ReferenceEntry<K, V> next) { this.nextExpirable = next; }
/*      */     public MapMakerInternalMap.ReferenceEntry<K, V> getPreviousExpirable() { return this.previousExpirable; }
/*      */     public void setPreviousExpirable(MapMakerInternalMap.ReferenceEntry<K, V> previous) { this.previousExpirable = previous; }
/*      */     public MapMakerInternalMap.ReferenceEntry<K, V> getNextEvictable() { return this.nextEvictable; }
/*      */     public void setNextEvictable(MapMakerInternalMap.ReferenceEntry<K, V> next) { this.nextEvictable = next; }
...
/*      */ 
/*      */       
/* 1557 */       this.previousExpirable = MapMakerInternalMap.nullEntry(); } public long getExpirationTime() { return this.time; }
/*      */     public void setExpirationTime(long time) { this.time = time; }
/*      */     public MapMakerInternalMap.ReferenceEntry<K, V> getNextExpirable() { return this.nextExpirable; }
/*      */     public void setNextExpirable(MapMakerInternalMap.ReferenceEntry<K, V> next) { this.nextExpirable = next; }
/*      */     public MapMakerInternalMap.ReferenceEntry<K, V> getPreviousExpirable() {
...
/*      */ 
/*      */       
/* 1593 */       this.previousEvictable = MapMakerInternalMap.nullEntry(); } public MapMakerInternalMap.ReferenceEntry<K, V> getNextEvictable() {
/*      */       return this.nextEvictable;
/*      */     } public void setNextEvictable(MapMakerInternalMap.ReferenceEntry<K, V> next) {
/*      */       this.nextEvictable = next;
/*      */     } public MapMakerInternalMap.ReferenceEntry<K, V> getPreviousEvictable() {
...
/*      */ 
/*      */       
/* 1669 */       this.previousEvictable = MapMakerInternalMap.nullEntry(); } public long getExpirationTime() { return this.time; } public void setExpirationTime(long time) { this.time = time; } public MapMakerInternalMap.ReferenceEntry<K, V> getNextExpirable() { return this.nextExpirable; } public void setNextExpirable(MapMakerInternalMap.ReferenceEntry<K, V> next) { this.nextExpirable = next; }
/*      */     public MapMakerInternalMap.ReferenceEntry<K, V> getPreviousExpirable() { return this.previousExpirable; }
/*      */     public void setPreviousExpirable(MapMakerInternalMap.ReferenceEntry<K, V> previous) { this.previousExpirable = previous; }
/*      */     public MapMakerInternalMap.ReferenceEntry<K, V> getNextEvictable() { return this.nextEvictable; }
/*      */     public void setNextEvictable(MapMakerInternalMap.ReferenceEntry<K, V> next) { this.nextEvictable = next; }
...
/* Location:              D:\Paper-1.7.10\PaperSpigot-1.7.10-R0.1-SNAPSHOT-latest.jar!\net\minecraf\\util\com\google\common\collect\MapMakerInternalMap.class
