...
/*  83 */     SpdyDataFrame frame = new DefaultSpdyDataFrame(getStreamId(), content().copy());
...
/*  90 */     SpdyDataFrame frame = new DefaultSpdyDataFrame(getStreamId(), content().duplicate());
