...
/* 115 */       System.arraycopy(this.array, readerIndex(), newArray, readerIndex(), readableBytes());
...
/* 270 */     return ByteBuffer.wrap(this.array, index, length);
/*     */   }
/*     */ 
/*     */   
...
/* 280 */     return (ByteBuffer)internalNioBuffer().clear().position(index).limit(index + length);
/*     */   }
/*     */ 
/*     */   
/*     */   public byte getByte(int index) {
/* 285 */     ensureAccessible();
/* 286 */     return _getByte(index);
/*     */   }
/*     */ 
/*     */   
/*     */   protected byte _getByte(int index) {
/* 291 */     return this.array[index];
/*     */   }
/*     */ 
/*     */   
/*     */   public short getShort(int index) {
/* 296 */     ensureAccessible();
/* 297 */     return _getShort(index);
/*     */   }
/*     */ 
/*     */   
/*     */   protected short _getShort(int index) {
/* 302 */     return (short)(this.array[index] << 8 | this.array[index + 1] & 0xFF);
/*     */   }
/*     */ 
/*     */   
/*     */   public int getUnsignedMedium(int index) {
/* 307 */     ensureAccessible();
/* 308 */     return _getUnsignedMedium(index);
/*     */   }
/*     */ 
/*     */   
/*     */   protected int _getUnsignedMedium(int index) {
/* 313 */     return (this.array[index] & 0xFF) << 16 | (this.array[index + 1] & 0xFF) << 8 | this.array[index + 2] & 0xFF;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 321 */     return _getInt(index);
/*     */   }
/*     */ 
/*     */   
/*     */   protected int _getInt(int index) {
/* 326 */     return (this.array[index] & 0xFF) << 24 | (this.array[index + 1] & 0xFF) << 16 | (this.array[index + 2] & 0xFF) << 8 | this.array[index + 3] & 0xFF;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 335 */     return _getLong(index);
/*     */   }
/*     */ 
/*     */   
/*     */   protected long _getLong(int index) {
/* 340 */     return (this.array[index] & 0xFFL) << 56L | (this.array[index + 1] & 0xFFL) << 48L | (this.array[index + 2] & 0xFFL) << 40L | (this.array[index + 3] & 0xFFL) << 32L | (this.array[index + 4] & 0xFFL) << 24L | (this.array[index + 5] & 0xFFL) << 16L | (this.array[index + 6] & 0xFFL) << 8L | this.array[index + 7] & 0xFFL;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 359 */     this.array[index] = (byte)value;
/*     */   }
/*     */ 
/*     */   
...
/* 371 */     this.array[index] = (byte)(value >>> 8);
/* 372 */     this.array[index + 1] = (byte)value;
/*     */   }
/*     */ 
/*     */   
/*     */   public ByteBuf setMedium(int index, int value) {
/* 377 */     ensureAccessible();
/* 378 */     _setMedium(index, value);
/* 379 */     return this;
/*     */   }
/*     */ 
/*     */   
/*     */   protected void _setMedium(int index, int value) {
/* 384 */     this.array[index] = (byte)(value >>> 16);
/* 385 */     this.array[index + 1] = (byte)(value >>> 8);
/* 386 */     this.array[index + 2] = (byte)value;
/*     */   }
/*     */ 
/*     */   
...
/* 398 */     this.array[index] = (byte)(value >>> 24);
/* 399 */     this.array[index + 1] = (byte)(value >>> 16);
/* 400 */     this.array[index + 2] = (byte)(value >>> 8);
/* 401 */     this.array[index + 3] = (byte)value;
/*     */   }
/*     */ 
/*     */   
/*     */   public ByteBuf setLong(int index, long value) {
/* 406 */     ensureAccessible();
/* 407 */     _setLong(index, value);
/* 408 */     return this;
/*     */   }
/*     */ 
/*     */   
/*     */   protected void _setLong(int index, long value) {
/* 413 */     this.array[index] = (byte)(int)(value >>> 56L);
/* 414 */     this.array[index + 1] = (byte)(int)(value >>> 48L);
/* 415 */     this.array[index + 2] = (byte)(int)(value >>> 40L);
/* 416 */     this.array[index + 3] = (byte)(int)(value >>> 32L);
/* 417 */     this.array[index + 4] = (byte)(int)(value >>> 24L);
/* 418 */     this.array[index + 5] = (byte)(int)(value >>> 16L);
/* 419 */     this.array[index + 6] = (byte)(int)(value >>> 8L);
/* 420 */     this.array[index + 7] = (byte)(int)value;
/*     */   }
/*     */ 
/*     */   
/*     */   public ByteBuf copy(int index, int length) {
/* 425 */     checkIndex(index, length);
/* 426 */     byte[] copiedArray = new byte[length];
/* 427 */     System.arraycopy(this.array, index, copiedArray, 0, length);
/* 428 */     return new UnpooledHeapByteBuf(alloc(), copiedArray, maxCapacity());
/*     */   }
/*     */   
/*     */   private ByteBuffer internalNioBuffer() {
/* 432 */     ByteBuffer tmpNioBuf = this.tmpNioBuf;
/* 433 */     if (tmpNioBuf == null) {
/* 434 */       this.tmpNioBuf = tmpNioBuf = ByteBuffer.wrap(this.array);
/*     */     }
/* 436 */     return tmpNioBuf;
/*     */   }
/*     */ 
/*     */   
