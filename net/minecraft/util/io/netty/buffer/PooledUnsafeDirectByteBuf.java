...
/* 320 */     PooledUnsafeDirectByteBuf copy = (PooledUnsafeDirectByteBuf)alloc().directBuffer(length, maxCapacity());
/* 321 */     if (length != 0) {
/* 322 */       PlatformDependent.copyMemory(addr(index), copy.addr(0), length);
/* 323 */       copy.setIndex(0, length);
/*     */     } 
/* 325 */     return copy;
/*     */   }
/*     */ 
...
/* 335 */     return new ByteBuffer[] { nioBuffer(index, length) };
/*     */   }
/*     */ 
/*     */   
/*     */   public ByteBuffer nioBuffer(int index, int length) {
/* 340 */     checkIndex(index, length);
/* 341 */     index = idx(index);
/* 342 */     return (ByteBuffer)this.memory.duplicate().position(index).limit(index + length);
/*     */   }
/*     */ 
/*     */   
...
/* 348 */     index = idx(index);
/* 349 */     return (ByteBuffer)internalNioBuffer().clear().position(index).limit(index + length);
/*     */   }
/*     */ 
/*     */   
...
/*     */   
/*     */   public byte[] array() {
/* 359 */     throw new UnsupportedOperationException("direct buffer");
/*     */   }
/*     */ 
/*     */   
/*     */   public int arrayOffset() {
/* 364 */     throw new UnsupportedOperationException("direct buffer");
/*     */   }
/*     */ 
/*     */   
...
/* 374 */     return this.memoryAddress;
/*     */   }
/*     */   
/*     */   private long addr(int index) {
/* 378 */     return this.memoryAddress + index;
/*     */   }
/*     */ 
/*     */   
