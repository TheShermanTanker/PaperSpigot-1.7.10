...
/* 123 */     UnpooledUnsafeDirectByteBuf copy = (UnpooledUnsafeDirectByteBuf)alloc().directBuffer(length, maxCapacity());
/* 124 */     if (length != 0) {
/* 125 */       PlatformDependent.copyMemory(addr(index), copy.addr(0), length);
/* 126 */       copy.setIndex(0, length);
/*     */     } 
/* 128 */     return copy;
/*     */   }
/*     */   
/*     */   private long addr(int index) {
/* 132 */     return this.memoryAddress + index;
/*     */   }
/*     */ }
