...
/* 261 */     index = idx(index);
/* 262 */     return (ByteBuffer)ByteBuffer.wrap(this.memory).position(index).limit(index + length);
/*     */   }
/*     */ 
/*     */   
...
/* 268 */     index = idx(index);
/* 269 */     return (ByteBuffer)internalNioBuffer().clear().position(index).limit(index + length);
/*     */   }
/*     */ 
/*     */   
...
/* 299 */     return ByteBuffer.wrap(memory);
/*     */   }
/*     */ 
/*     */   
