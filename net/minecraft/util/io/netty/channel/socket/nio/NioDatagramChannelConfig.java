...
/*     */   
/*     */   static {
/*  43 */     ClassLoader classLoader = DatagramChannel.class.getClassLoader();
...
/*     */     }
/*     */     try {
/* 169 */       return GET_OPTION.invoke(this.javaChannel, new Object[] { option });
...
/* 177 */     if (PlatformDependent.javaVersion() < 7) {
/* 178 */       throw new UnsupportedOperationException();
/*     */     }
/*     */     try {
/* 181 */       SET_OPTION.invoke(this.javaChannel, new Object[] { option, value });
