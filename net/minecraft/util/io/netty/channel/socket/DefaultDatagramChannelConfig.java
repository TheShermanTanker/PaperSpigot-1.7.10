...
/*  65 */     return getOptions(super.getOptions(), new ChannelOption[] { ChannelOption.SO_BROADCAST, ChannelOption.SO_RCVBUF, ChannelOption.SO_SNDBUF, ChannelOption.SO_REUSEADDR, ChannelOption.IP_MULTICAST_LOOP_DISABLED, ChannelOption.IP_MULTICAST_ADDR, ChannelOption.IP_MULTICAST_IF, ChannelOption.IP_MULTICAST_TTL, ChannelOption.IP_TOS, ChannelOption.DATAGRAM_CHANNEL_ACTIVE_ON_REGISTRATION });
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  74 */     if (option == ChannelOption.SO_BROADCAST) {
/*  75 */       return (T)Boolean.valueOf(isBroadcast());
/*     */     }
/*  77 */     if (option == ChannelOption.SO_RCVBUF) {
/*  78 */       return (T)Integer.valueOf(getReceiveBufferSize());
/*     */     }
/*  80 */     if (option == ChannelOption.SO_SNDBUF) {
/*  81 */       return (T)Integer.valueOf(getSendBufferSize());
/*     */     }
/*  83 */     if (option == ChannelOption.SO_REUSEADDR) {
/*  84 */       return (T)Boolean.valueOf(isReuseAddress());
/*     */     }
/*  86 */     if (option == ChannelOption.IP_MULTICAST_LOOP_DISABLED) {
/*  87 */       return (T)Boolean.valueOf(isLoopbackModeDisabled());
/*     */     }
/*  89 */     if (option == ChannelOption.IP_MULTICAST_ADDR) {
/*  90 */       return (T)getInterface();
/*     */     }
/*     */     
...
/*     */     }
/*     */     
/*  97 */     if (option == ChannelOption.IP_MULTICAST_TTL) {
/*  98 */       return (T)Integer.valueOf(getTimeToLive());
/*     */     }
/* 100 */     if (option == ChannelOption.IP_TOS) {
/* 101 */       return (T)Integer.valueOf(getTrafficClass());
/*     */     }
/* 103 */     if (option == ChannelOption.DATAGRAM_CHANNEL_ACTIVE_ON_REGISTRATION) {
/* 104 */       return (T)Boolean.valueOf(this.activeOnOpen);
/*     */     }
/* 106 */     return (T)super.getOption(option);
/*     */   }
/*     */ 
/*     */   
